...
/usr/local/cuda/bin/nvcc -ccbin g++-7 -I/usr/local/hyesoon/cupbop/CuPBoP/cuda-10.1/samples/common/inc  -m64    -gencode arch=compute_30,code=sm_30 -gencode arch=compute_30,code=compute_30 -o dummy_host_kernel.o -c dummy_host_kernel.cu
...
/usr/local/cuda/bin/nvcc -ccbin g++   -m64      -gencode arch=compute_30,code=sm_30 -gencode arch=compute_30,code=compute_30 -o dummy_host_kernel  dummy_host_kernel.o 