...
then
    ...
    LD_LIBRARY_PATH=../../build/runtime/threadPool:${VORTEX_PATH}/runtime:../../build/runtime:${LD_LIBRARY_PATH} ./host.out -n 65536 -l 256 > Batch_vortex_test1.log #>  host_out.dump
