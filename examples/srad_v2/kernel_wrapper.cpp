...
extern  "C" {
 extern void *  _Z11srad_cuda_1PfS_S_S_S_S_iiff_wrapper(void **args);
}
extern  "C" {
 extern void *  _Z11srad_cuda_2PfS_S_S_S_S_iiff_wrapper(void **args);
}

void cuda__Z11srad_cuda_1PfS_S_S_S_S_iiff_wrapper(
   const void * args, 
   ...
   uint32_t /*group_z*/) { 
     ...
     _Z11srad_cuda_1PfS_S_S_S_S_iiff_wrapper((void **)args);
}

void cuda__Z11srad_cuda_2PfS_S_S_S_S_iiff_wrapper(
   const void * args, 
   const context_t* /*context*/, 
   uint32_t group_x, 
   uint32_t group_y, 
   uint32_t /*group_z*/) { 
     block_index_x = group_x;
     block_index_y = group_y;
     _Z11srad_cuda_2PfS_S_S_S_S_iiff_wrappers((void **)args);
}
 
vx_spawn_kernel_cb callbacks[] = {
 cuda__Z11srad_cuda_1PfS_S_S_S_S_iiff_wrapper, cuda__Z11srad_cuda_2PfS_S_S_S_S_iiff_wrapper}; 
