...
@callbacks = dso_local global [2 x ptr] [ptr @_Z39cuda_srad_cuda_1PfS_S_S_S_S_iif_wrapperPv, ptr @_Z40cuda_srad_cuda_2PfS_S_S_S_S_iiff_wrapperPv], align 8
...
; Function Attrs: mustprogress nounwind uwtable
define dso_local void @_Z39cuda_srad_cuda_1PfS_S_S_S_S_iif_wrapperPv(ptr noundef %args) #1 {
entry:
  ...
  call void @srad_cuda_1PfS_S_S_S_S_iif_wrapper(ptr noundef %18)
  ret void
}

declare dso_local void @srad_cuda_1PfS_S_S_S_S_iif_wrapper(ptr noundef) #4

; Function Attrs: mustprogress nounwind uwtable
define dso_local void @_Z40cuda_srad_cuda_2PfS_S_S_S_S_iiff_wrapperPv(ptr noundef %args) #1 {
entry:
  %args.addr = alloca ptr, align 8
  store ptr %args, ptr %args.addr, align 8, !tbaa !16
  %0 = call align 4 ptr @llvm.threadlocal.address.p0(ptr align 4 @blockIdx)
  ...
  store i32 %16, ptr %17, align 4, !tbaa !8
  %18 = load ptr, ptr %args.addr, align 8, !tbaa !16
  call void @srad_cuda_2PfS_S_S_S_S_iiff_wrapper(ptr noundef %18)
  ret void
}

declare dso_local void @srad_cuda_2PfS_S_S_S_S_iiff_wrapper(ptr noundef) #4
...
if.end:                                           ; preds = %while.end, %entry
  ...
  %arrayidx36 = getelementptr inbounds [2 x ptr], ptr @callbacks, i64 0, i64 %idxprom35
