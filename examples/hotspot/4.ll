...
entry_after_block_sync_2_after_block_sync_3:      ; preds = %entry_after_block_sync_2
...
if.end:                                           ; preds = %if.then, %land.lhs.true24, %land.lhs.true22, %land.lhs.true, %entry_after_block_sync_2_after_block_sync_3
  br label %if.end_after_block_sync_8, !dbg !1149

if.end_after_block_sync_8:                        ; preds = %if.end
  call void @llvm.nvvm.barrier0(), !dbg !1149
  br label %if.end_after_block_sync_8_after_block_sync_9, !dbg !1150

if.end_after_block_sync_8_after_block_sync_9:     ; preds = %if.end_after_block_sync_8
  call void @llvm.dbg.declare(metadata ptr %validYmin, metadata !1151, metadata !DIExpression()), !dbg !1152
  %46 = load i32, ptr %blkY, align 4, !dbg !1150
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  store i32 %48, ptr %validYmin, align 4, !dbg !1152
...
cond.end85_after_block_sync_20:                   ; preds = %cond.end85
  call void @llvm.nvvm.barrier0()
  br label %cond.end85_after_block_sync_4, !dbg !1237
...
for.cond_after_block_sync_28:                     ; preds = %for.cond
  call void @llvm.nvvm.barrier0()
  br label %for.cond_after_block_sync_5, !dbg !1238
...
for.cond_after_block_sync_5_after_block_sync_21:  ; preds = %for.cond_after_block_sync_5_after_block_sync_31
  call void @llvm.nvvm.barrier0()
  br label %for.cond_after_block_sync_5_after_block_sync_6, !dbg !1242
...
for.body_after_block_sync_29:                     ; preds = %for.body
  call void @llvm.nvvm.barrier0()
  br label %for.body_after_block_sync_7, !dbg !1243

for.body_after_block_sync_7:                      ; preds = %for.body_after_block_sync_29
...
if.end175:                                        ; preds = %if.then109, %land.lhs.true107, %land.lhs.true105, %land.lhs.true103, %land.lhs.true101, %land.lhs.true97, %land.lhs.true94, %land.lhs.true90, %for.body_after_block_sync_7
  br label %if.end175_after_block_sync_14, !dbg !1339

if.end175_after_block_sync_14:                    ; preds = %if.end175
  call void @llvm.nvvm.barrier0(), !dbg !1339
  br label %if.end175_after_block_sync_14_after_block_sync_15, !dbg !1340
...
if.end175_after_block_sync_0_after_block_sync_30: ; preds = %if.end175_after_block_sync_0
  call void @llvm.nvvm.barrier0()
  br label %if.end175_after_block_sync_0_after_block_sync_16, !dbg !1345
...
if.then178_after_block_sync_24_after_block_sync_27_after_block_sync_34: ; preds = %if.then178_after_block_sync_24_after_block_sync_27
  call void @llvm.nvvm.barrier0()
  br label %if.then178_after_block_sync_17, !dbg !1346
...
if.end179:                                        ; preds = %if.end175_after_block_sync_0_after_block_sync_16
...
if.end189:                                        ; preds = %if.then180, %if.end179
  br label %if.end189_after_block_sync_10, !dbg !1359

if.end189_after_block_sync_10:                    ; preds = %if.end189
  call void @llvm.nvvm.barrier0(), !dbg !1359
  br label %if.end189_after_block_sync_10_after_block_sync_11, !dbg !1360
...
for.end.loopexit_after_block_sync_23_after_block_sync_26_after_block_sync_33: ; preds = %for.end.loopexit_after_block_sync_23_after_block_sync_26
  call void @llvm.nvvm.barrier0()
  br label %for.end.loopexit_after_block_sync_19, !dbg !1366
...
for.end_after_block_sync_22:                      ; preds = %for.end_after_block_sync_25
  call void @llvm.nvvm.barrier0()
  br label %for.end_after_block_sync_12, !dbg !1366

for.end_after_block_sync_12:                      ; preds = %for.end_after_block_sync_22
...
if.end198_after_block_sync_1:                     ; preds = %if.end198
  call void @llvm.nvvm.barrier0()
  br label %if.end198_after_block_sync_1_after_block_sync_13, !dbg !1377
...
!1150 = !DILocation(line: 164, column: 20, scope: !128)
!1151 = !DILocalVariable(name: "validYmin", scope: !128, file: !129, line: 164, type: !132)
!1152 = !DILocation(line: 164, column: 7, scope: !128)
