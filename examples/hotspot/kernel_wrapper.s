...
.Lfunc_end1:
	...
	.cfi_endproc
                                        # -- End function
	.section	.text._Z44cuda_calculate_tempiPfS_S_iiiiffffff_wrapperPv,"ax",@progbits
	.globl	_Z44cuda_calculate_tempiPfS_S_iiiiffffff_wrapperPv # -- Begin function _Z44cuda_calculate_tempiPfS_S_iiiiffffff_wrapperPv
	.p2align	2
	.type	_Z44cuda_calculate_tempiPfS_S_iiiiffffff_wrapperPv,@function
_Z44cuda_calculate_tempiPfS_S_iiiiffffff_wrapperPv: # @_Z44cuda_calculate_tempiPfS_S_iiiiffffff_wrapperPv
	.cfi_startproc
# %bb.0:                                # %entry
.Lpcrel_hi1:
...
.Lpcrel_hi2:
	...
	tail	calculate_tempiPfS_S_iiiiffffff_wrapper
.Lfunc_end2:
	.size	_Z44cuda_calculate_tempiPfS_S_iiiiffffff_wrapperPv, .Lfunc_end2-_Z44cuda_calculate_tempiPfS_S_iiiiffffff_wrapperPv
	.cfi_endproc
                                        # -- End function
...
.Lpcrel_hi3:
	...
	lw	a2, 4(s0)
	sw	a0, %pcrel_lo(.Lpcrel_hi3)(a1)
.Lpcrel_hi4:
	auipc	a0, %pcrel_hi(grid_size_y)
	lw	a1, 8(s0)
	sw	a2, %pcrel_lo(.Lpcrel_hi4)(a0)
.Lpcrel_hi5:
	auipc	a0, %pcrel_hi(grid_size_z)
	lw	a2, 24(s0)
	sw	a1, %pcrel_lo(.Lpcrel_hi5)(a0)
.Lpcrel_hi6:
...
.Lpcrel_hi8:
	...
	lw	a3, 60(s0)
	sw	a1, %pcrel_lo(.Lpcrel_hi8)(a0)
	lw	a0, 28(s0)
.Lpcrel_hi9:
	auipc	a1, %pcrel_hi(dyn_shared_mem_size)
	sw	a3, %pcrel_lo(.Lpcrel_hi9)(a1)
.Lpcrel_hi7:
...
dyn_shared_mem_size:
	...
	.p2align	3, 0x0
callbacks:
	.quad	_Z44cuda_calculate_tempiPfS_S_iiiiffffff_wrapperPv
	.size	callbacks, 8
...
.L.str:
	...
	.addrsig_sym _Z44cuda_calculate_tempiPfS_S_iiiiffffff_wrapperPv
