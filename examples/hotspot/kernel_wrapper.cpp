...
extern  "C" {
 extern void *  _Z14calculate_tempiPfS_S_iiiiffffff_wrapper(void **args);
}


void cuda__Z14calculate_tempiPfS_S_iiiiffffff_wrapper(
   const void * args, 
   ...
   uint32_t /*group_z*/) { 
     ...
     _Z14calculate_tempiPfS_S_iiiiffffff_wrapper((void **)args);
}


vx_spawn_kernel_cb callbacks[] = {
 cuda__Z14calculate_tempiPfS_S_iiiiffffff_wrapper}; 
