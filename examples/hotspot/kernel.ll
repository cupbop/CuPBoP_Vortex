...
entry_after_block_sync_2_after_block_sync_3:      ; preds = %if.end, %entry_after_block_sync_2_after_block_sync_3.lr.ph
...
if.end_after_block_sync_8_after_block_sync_9:     ; preds = %if.end_after_block_sync_8_after_block_sync_9, %if.end_after_block_sync_8_after_block_sync_9.lr.ph
...
intra_warp_cond99.preheader:                      ; preds = %intra_reset_block98, %for.cond.preheader
...
for.body_after_block_sync_7:                      ; preds = %if.end175, %for.body_after_block_sync_7.lr.ph
...
if.end179:                                        ; preds = %if.end189, %intra_warp_cond94.preheader
...
for.end_after_block_sync_12:                      ; preds = %if.end198, %intra_warp_init
