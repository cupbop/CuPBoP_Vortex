...
then
    ...
    LD_LIBRARY_PATH=../../build/runtime/threadPool:${VORTEX_PATH}/runtime/simx:../../build/runtime:${LD_LIBRARY_PATH} ./host.out filelist.txt -r 10 -lat 30 -lng 90 > res_vortex.log
