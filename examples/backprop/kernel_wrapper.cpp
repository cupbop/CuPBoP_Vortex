...
extern  "C" {
 extern void *  _Z24bpnn_adjust_weights_cudaPfiS_iS_S__wrapper(void **args);
}
extern  "C" {
 extern void *  _Z22bpnn_layerforward_CUDAPfS_S_S_ii_wrapper(void **args);
}

void cuda__Z24bpnn_adjust_weights_cudaPfiS_iS_S__wrapper(
   const void * args, 
   ...
   uint32_t /*group_z*/) { 
     ...
     _Z24bpnn_adjust_weights_cudaPfiS_iS_S__wrapper((void **)args);
}

void cuda__Z22bpnn_layerforward_CUDAPfS_S_S_ii_wrapper(
   const void * args, 
   const context_t* /*context*/, 
   uint32_t group_x, 
   uint32_t group_y, 
   uint32_t /*group_z*/) { 
     block_index_x = group_x;
     block_index_y = group_y;
     _Z22bpnn_layerforward_CUDAPfS_S_S_ii_wrapper((void **)args);
}
 
vx_spawn_kernel_cb callbacks[] = {
 cuda__Z24bpnn_adjust_weights_cudaPfiS_iS_S__wrapper, 
 cuda__Z22bpnn_layerforward_CUDAPfS_S_S_ii_wrapper}; 
