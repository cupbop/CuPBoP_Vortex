...
then
    ...
    VX_CFLAGS="-v -O3 -std=c++11 -target riscv32 -march=rv32imf -mabi=ilp32f -mcmodel=medany -fno-rtti -fno-exceptions -nostartfiles -fdata-sections -ffunction-sections -I${VORTEX_PATH}/kernel/include -I${VORTEX_PATH}/kernel/../hw"
     ...
     VX_CFLAGS_C="-v -O3 -target riscv32 -march=rv32imf -mabi=ilp32f -mcmodel=medany -fno-rtti -fno-exceptions -nostartfiles -fdata-sections -ffunction-sections -I${VORTEX_PATH}/kernel/include -I${VORTEX_PATH}/kernel/../hw"
    ...
    ${LLVM_PREFIX}/bin/clang ${VX_CFLAGS_C} -c -emit-llvm facetrain.c 
    ${LLVM_PREFIX}/bin/clang ${VX_CFLAGS_C} -c -emit-llvm backprop.c   
    ${LLVM_PREFIX}/bin/clang ${VX_CFLAGS_C} -c -emit-llvm imagenet.c  
    ...
    echo "hello3"
    ${LLVM_PREFIX}/bin/clang++ ${VX_CFLAGS} --gcc-toolchain=${RISCV_TOOLCHAIN_PATH} kernel_wrapper.o kernel.o ${CuPBoP_PATH}/runtime/src/vortex/kernel/cudaKernelImpl.o backprop.o facetrain.o imagenet.o  -lm ${VX_LDFLAGS} -o kernel.elf 
    ...
    LD_LIBRARY_PATH=../../build/runtime/threadPool:${VORTEX_PATH}/runtime/simx:../../build/runtime:${LD_LIBRARY_PATH} ./host.out 1024 > res.log
