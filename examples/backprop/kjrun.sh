...
clang++ -g -std=c++11  ./$KERNEL_CU backprop.o facetrain.o imagenet.o -I../.. --cuda-path=$CUDA_PATH --cuda-gpu-arch=sm_50 -L$CUDA_PATH/lib64  -lcudart_static -ldl -lrt -pthread -save-temps -v  || true
...
then
    ...
    g++ -g -O0 -Wall -L../../build/runtime -L../../build/runtime/threadPool -L${VORTEX_PATH}/runtime/stub -I${VORTEX_PATH}/kernel/include -o host.out -fPIC -no-pie host.o host_vortexrt.o backprop.o facetrain.o imagenet.o -lc -lvortexRuntime -lvortex -lThreadPool -lpthread 
