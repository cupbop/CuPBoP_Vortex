...
then
    ...
    ${RISCV_TOOLCHAIN_PREFIX}objdump -D kernel.elf > kernel.dump
    echo "!!!!"
    g++ -g -O0 -Wall -L../../build/runtime  -L../../build/runtime/threadPool  -L${VORTEX_PATH}/driver/stub -I${VORTEX_PATH}/runtime/include -o pathfinder -fPIC -no-pie host.o host_vortexrt.o  -lc -lvortexRuntime -lvortex -lThreadPool -lpthread 
