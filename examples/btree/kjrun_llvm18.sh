...
then
    ...
    LD_LIBRARY_PATH=../../build/runtime/threadÍPool:${VORTEX_PATH}/runtime/simx:../../build/runtime:${LD_LIBRARY_PATH} ./host.out file ../../data/b+tree/mil.txt command ../../data/b+tree/command.txt > CGO_vortex_test1.log
