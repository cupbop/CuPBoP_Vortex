...
clang++ -g -O3 -std=c++11  ./$KERNEL_CU ./common/common.o -I../.. -I$ADDITIONAL_PATH --cuda-path=$CUDA_PATH --cuda-gpu-arch=sm_50 -L$CUDA_PATH/lib64  -lcudart_static -ldl -lrt -pthread -save-temps -v  || true
...
then
    ...
    g++ -g -O0 -Wall -L../../build/runtime -L../../build/runtime/threadPool -L${VORTEX_PATH}/runtime/stub -I${VORTEX_PATH}/kernel/include -I$ADDITIONAL_PATH -o host.out -fPIC -no-pie host.o host_vortexrt.o ./common/common.o  -lc -lvortexRuntime -lvortex -lThreadPool -lpthread 
    ...
    echo "--- Execution completed!"    exit -1
fi
