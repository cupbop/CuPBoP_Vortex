...
define dso_local void @_Z4Fan1PfS_ii(ptr noundef %m_cuda, ptr noundef %a_cuda, i32 noundef %Size, i32 noundef %t) #0 !dbg !1011 {
entry:
  ...
  call void @llvm.dbg.declare(metadata ptr %m_cuda.addr, metadata !1016, metadata !DIExpression()), !dbg !1017
  ...
  %call = call noundef i32 @_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_xEv() #3, !dbg !1024
  %call1 = call noundef i32 @_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_xEv() #3, !dbg !1026
  %call2 = call noundef i32 @_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_xEv() #3, !dbg !1027
  %mul = mul i32 %call1, %call2, !dbg !1028
  %add = add i32 %call, %mul, !dbg !1029
  %0 = load i32, ptr %Size.addr, align 4, !dbg !1030
  %sub = sub nsw i32 %0, 1, !dbg !1031
  %1 = load i32, ptr %t.addr, align 4, !dbg !1032
  %sub3 = sub nsw i32 %sub, %1, !dbg !1033
  %cmp = icmp uge i32 %add, %sub3, !dbg !1034
...
if.end:                                           ; preds = %entry
  %2 = load ptr, ptr %a_cuda.addr, align 8, !dbg !1037
  %3 = load i32, ptr %Size.addr, align 4, !dbg !1038
  %call4 = call noundef i32 @_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_xEv() #3, !dbg !1039
  %call5 = call noundef i32 @_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_xEv() #3, !dbg !1040
  %mul6 = mul i32 %call4, %call5, !dbg !1041
  %call7 = call noundef i32 @_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_xEv() #3, !dbg !1042
  %add8 = add i32 %mul6, %call7, !dbg !1043
  %4 = load i32, ptr %t.addr, align 4, !dbg !1044
  %add9 = add i32 %add8, %4, !dbg !1045
  %add10 = add i32 %add9, 1, !dbg !1046
  %mul11 = mul i32 %3, %add10, !dbg !1047
  %idx.ext = zext i32 %mul11 to i64, !dbg !1048
  %add.ptr = getelementptr inbounds float, ptr %2, i64 %idx.ext, !dbg !1048
  %5 = load i32, ptr %t.addr, align 4, !dbg !1049
  %idx.ext12 = sext i32 %5 to i64, !dbg !1050
  %add.ptr13 = getelementptr inbounds float, ptr %add.ptr, i64 %idx.ext12, !dbg !1050
  %6 = load float, ptr %add.ptr13, align 4, !dbg !1051
  %7 = load ptr, ptr %a_cuda.addr, align 8, !dbg !1052
  %8 = load i32, ptr %Size.addr, align 4, !dbg !1053
  %9 = load i32, ptr %t.addr, align 4, !dbg !1054
  %mul14 = mul nsw i32 %8, %9, !dbg !1055
  %idx.ext15 = sext i32 %mul14 to i64, !dbg !1056
  %add.ptr16 = getelementptr inbounds float, ptr %7, i64 %idx.ext15, !dbg !1056
  %10 = load i32, ptr %t.addr, align 4, !dbg !1057
  %idx.ext17 = sext i32 %10 to i64, !dbg !1058
  %add.ptr18 = getelementptr inbounds float, ptr %add.ptr16, i64 %idx.ext17, !dbg !1058
  %11 = load float, ptr %add.ptr18, align 4, !dbg !1059
  %div = fdiv contract float %6, %11, !dbg !1060
  %12 = load ptr, ptr %m_cuda.addr, align 8, !dbg !1061
  %13 = load i32, ptr %Size.addr, align 4, !dbg !1062
  %call19 = call noundef i32 @_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_xEv() #3, !dbg !1063
  %call20 = call noundef i32 @_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_xEv() #3, !dbg !1064
  %mul21 = mul i32 %call19, %call20, !dbg !1065
  %call22 = call noundef i32 @_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_xEv() #3, !dbg !1066
  %add23 = add i32 %mul21, %call22, !dbg !1067
  %14 = load i32, ptr %t.addr, align 4, !dbg !1068
  %add24 = add i32 %add23, %14, !dbg !1069
  %add25 = add i32 %add24, 1, !dbg !1070
  %mul26 = mul i32 %13, %add25, !dbg !1071
  %idx.ext27 = zext i32 %mul26 to i64, !dbg !1072
  %add.ptr28 = getelementptr inbounds float, ptr %12, i64 %idx.ext27, !dbg !1072
  %15 = load i32, ptr %t.addr, align 4, !dbg !1073
  %idx.ext29 = sext i32 %15 to i64, !dbg !1074
  %add.ptr30 = getelementptr inbounds float, ptr %add.ptr28, i64 %idx.ext29, !dbg !1074
  store float %div, ptr %add.ptr30, align 4, !dbg !1075
...
define linkonce_odr dso_local noundef i32 @_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_xEv() #2 comdat align 2 !dbg !1077 {
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !dbg !1078
  ret i32 %0, !dbg !1079
}

; Function Attrs: alwaysinline convergent mustprogress nounwind
define linkonce_odr dso_local noundef i32 @_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_xEv() #2 comdat align 2 !dbg !1080 {
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !dbg !1081
  ret i32 %0, !dbg !1082
}

; Function Attrs: alwaysinline convergent mustprogress nounwind
define linkonce_odr dso_local noundef i32 @_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_xEv() #2 comdat align 2 !dbg !1083 {
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ntid.x(), !dbg !1084
  ret i32 %0, !dbg !1085
}

; Function Attrs: convergent mustprogress noinline norecurse nounwind optnone
define dso_local void @_Z4Fan2PfS_S_iii(ptr noundef %m_cuda, ptr noundef %a_cuda, ptr noundef %b_cuda, i32 noundef %Size, i32 noundef %j1, i32 noundef %t) #0 !dbg !1086 {
entry:
  %m_cuda.addr = alloca ptr, align 8
  %a_cuda.addr = alloca ptr, align 8
  ...
  store ptr %m_cuda, ptr %m_cuda.addr, align 8
  call void @llvm.dbg.declare(metadata ptr %m_cuda.addr, metadata !1089, metadata !DIExpression()), !dbg !1090
  store ptr %a_cuda, ptr %a_cuda.addr, align 8
  call void @llvm.dbg.declare(metadata ptr %a_cuda.addr, metadata !1091, metadata !DIExpression()), !dbg !1092
  store ptr %b_cuda, ptr %b_cuda.addr, align 8
  call void @llvm.dbg.declare(metadata ptr %b_cuda.addr, metadata !1093, metadata !DIExpression()), !dbg !1094
  store i32 %Size, ptr %Size.addr, align 4
  call void @llvm.dbg.declare(metadata ptr %Size.addr, metadata !1095, metadata !DIExpression()), !dbg !1096
  store i32 %j1, ptr %j1.addr, align 4
  call void @llvm.dbg.declare(metadata ptr %j1.addr, metadata !1097, metadata !DIExpression()), !dbg !1098
  store i32 %t, ptr %t.addr, align 4
  call void @llvm.dbg.declare(metadata ptr %t.addr, metadata !1099, metadata !DIExpression()), !dbg !1100
  %call = call noundef i32 @_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_xEv() #3, !dbg !1101
  %call1 = call noundef i32 @_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_xEv() #3, !dbg !1103
  %call2 = call noundef i32 @_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_xEv() #3, !dbg !1104
  %mul = mul i32 %call1, %call2, !dbg !1105
  %add = add i32 %call, %mul, !dbg !1106
  %0 = load i32, ptr %Size.addr, align 4, !dbg !1107
  %sub = sub nsw i32 %0, 1, !dbg !1108
  %1 = load i32, ptr %t.addr, align 4, !dbg !1109
  %sub3 = sub nsw i32 %sub, %1, !dbg !1110
  %cmp = icmp uge i32 %add, %sub3, !dbg !1111
...
if.end:                                           ; preds = %entry
  %call4 = call noundef i32 @_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_yEv() #3, !dbg !1114
  %call5 = call noundef i32 @_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_yEv() #3, !dbg !1116
  %call6 = call noundef i32 @_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_yEv() #3, !dbg !1117
  %mul7 = mul i32 %call5, %call6, !dbg !1118
  %add8 = add i32 %call4, %mul7, !dbg !1119
  %2 = load i32, ptr %Size.addr, align 4, !dbg !1120
  %3 = load i32, ptr %t.addr, align 4, !dbg !1121
  %sub9 = sub nsw i32 %2, %3, !dbg !1122
  %cmp10 = icmp uge i32 %add8, %sub9, !dbg !1123
  br i1 %cmp10, label %if.then11, label %if.end12, !dbg !1124

if.then11:                                        ; preds = %if.end
  br label %if.end58, !dbg !1125

if.end12:                                         ; preds = %if.end
  call void @llvm.dbg.declare(metadata ptr %xidx, metadata !1126, metadata !DIExpression()), !dbg !1127
  %call13 = call noundef i32 @_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_xEv() #3, !dbg !1128
  %call14 = call noundef i32 @_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_xEv() #3, !dbg !1129
  %mul15 = mul i32 %call13, %call14, !dbg !1130
  %call16 = call noundef i32 @_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_xEv() #3, !dbg !1131
  %add17 = add i32 %mul15, %call16, !dbg !1132
  store i32 %add17, ptr %xidx, align 4, !dbg !1127
  call void @llvm.dbg.declare(metadata ptr %yidx, metadata !1133, metadata !DIExpression()), !dbg !1134
  %call18 = call noundef i32 @_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_yEv() #3, !dbg !1135
  %call19 = call noundef i32 @_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_yEv() #3, !dbg !1136
  %mul20 = mul i32 %call18, %call19, !dbg !1137
  %call21 = call noundef i32 @_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_yEv() #3, !dbg !1138
  %add22 = add i32 %mul20, %call21, !dbg !1139
  store i32 %add22, ptr %yidx, align 4, !dbg !1134
  %4 = load ptr, ptr %m_cuda.addr, align 8, !dbg !1140
  %5 = load i32, ptr %Size.addr, align 4, !dbg !1141
  %6 = load i32, ptr %xidx, align 4, !dbg !1142
  %add23 = add nsw i32 %6, 1, !dbg !1143
  %7 = load i32, ptr %t.addr, align 4, !dbg !1144
  %add24 = add nsw i32 %add23, %7, !dbg !1145
  %mul25 = mul nsw i32 %5, %add24, !dbg !1146
  %8 = load i32, ptr %t.addr, align 4, !dbg !1147
  %add26 = add nsw i32 %mul25, %8, !dbg !1148
  %idxprom = sext i32 %add26 to i64, !dbg !1140
  %arrayidx = getelementptr inbounds float, ptr %4, i64 %idxprom, !dbg !1140
  %9 = load float, ptr %arrayidx, align 4, !dbg !1140
  %10 = load ptr, ptr %a_cuda.addr, align 8, !dbg !1149
  %11 = load i32, ptr %Size.addr, align 4, !dbg !1150
  %12 = load i32, ptr %t.addr, align 4, !dbg !1151
  %mul27 = mul nsw i32 %11, %12, !dbg !1152
  %13 = load i32, ptr %yidx, align 4, !dbg !1153
  %14 = load i32, ptr %t.addr, align 4, !dbg !1154
  %add28 = add nsw i32 %13, %14, !dbg !1155
  %add29 = add nsw i32 %mul27, %add28, !dbg !1156
  %idxprom30 = sext i32 %add29 to i64, !dbg !1149
  %arrayidx31 = getelementptr inbounds float, ptr %10, i64 %idxprom30, !dbg !1149
  %15 = load float, ptr %arrayidx31, align 4, !dbg !1149
  %mul32 = fmul contract float %9, %15, !dbg !1157
  %16 = load ptr, ptr %a_cuda.addr, align 8, !dbg !1158
  %17 = load i32, ptr %Size.addr, align 4, !dbg !1159
  %18 = load i32, ptr %xidx, align 4, !dbg !1160
  %add33 = add nsw i32 %18, 1, !dbg !1161
  %19 = load i32, ptr %t.addr, align 4, !dbg !1162
  %add34 = add nsw i32 %add33, %19, !dbg !1163
  %mul35 = mul nsw i32 %17, %add34, !dbg !1164
  %20 = load i32, ptr %yidx, align 4, !dbg !1165
  %21 = load i32, ptr %t.addr, align 4, !dbg !1166
  %add36 = add nsw i32 %20, %21, !dbg !1167
  %add37 = add nsw i32 %mul35, %add36, !dbg !1168
  %idxprom38 = sext i32 %add37 to i64, !dbg !1158
  %arrayidx39 = getelementptr inbounds float, ptr %16, i64 %idxprom38, !dbg !1158
  %22 = load float, ptr %arrayidx39, align 4, !dbg !1169
  %sub40 = fsub contract float %22, %mul32, !dbg !1169
  store float %sub40, ptr %arrayidx39, align 4, !dbg !1169
  %23 = load i32, ptr %yidx, align 4, !dbg !1170
  %cmp41 = icmp eq i32 %23, 0, !dbg !1172
  br i1 %cmp41, label %if.then42, label %if.end58, !dbg !1173

if.then42:                                        ; preds = %if.end12
  %24 = load ptr, ptr %m_cuda.addr, align 8, !dbg !1174
  %25 = load i32, ptr %Size.addr, align 4, !dbg !1176
  %26 = load i32, ptr %xidx, align 4, !dbg !1177
  %add43 = add nsw i32 %26, 1, !dbg !1178
  %27 = load i32, ptr %t.addr, align 4, !dbg !1179
  %add44 = add nsw i32 %add43, %27, !dbg !1180
  %mul45 = mul nsw i32 %25, %add44, !dbg !1181
  %28 = load i32, ptr %yidx, align 4, !dbg !1182
  %29 = load i32, ptr %t.addr, align 4, !dbg !1183
  %add46 = add nsw i32 %28, %29, !dbg !1184
  %add47 = add nsw i32 %mul45, %add46, !dbg !1185
  %idxprom48 = sext i32 %add47 to i64, !dbg !1174
  %arrayidx49 = getelementptr inbounds float, ptr %24, i64 %idxprom48, !dbg !1174
  %30 = load float, ptr %arrayidx49, align 4, !dbg !1174
  %31 = load ptr, ptr %b_cuda.addr, align 8, !dbg !1186
  %32 = load i32, ptr %t.addr, align 4, !dbg !1187
  %idxprom50 = sext i32 %32 to i64, !dbg !1186
  %arrayidx51 = getelementptr inbounds float, ptr %31, i64 %idxprom50, !dbg !1186
  %33 = load float, ptr %arrayidx51, align 4, !dbg !1186
  %mul52 = fmul contract float %30, %33, !dbg !1188
  %34 = load ptr, ptr %b_cuda.addr, align 8, !dbg !1189
  %35 = load i32, ptr %xidx, align 4, !dbg !1190
  %add53 = add nsw i32 %35, 1, !dbg !1191
  %36 = load i32, ptr %t.addr, align 4, !dbg !1192
  %add54 = add nsw i32 %add53, %36, !dbg !1193
  %idxprom55 = sext i32 %add54 to i64, !dbg !1189
  %arrayidx56 = getelementptr inbounds float, ptr %34, i64 %idxprom55, !dbg !1189
  %37 = load float, ptr %arrayidx56, align 4, !dbg !1194
  %sub57 = fsub contract float %37, %mul52, !dbg !1194
  store float %sub57, ptr %arrayidx56, align 4, !dbg !1194
  br label %if.end58, !dbg !1195
...
; Function Attrs: alwaysinline convergent mustprogress nounwind
define linkonce_odr dso_local noundef i32 @_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_yEv() #2 comdat align 2 !dbg !1197 {
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.tid.y(), !dbg !1198
  ret i32 %0, !dbg !1199
}

; Function Attrs: alwaysinline convergent mustprogress nounwind
define linkonce_odr dso_local noundef i32 @_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_yEv() #2 comdat align 2 !dbg !1200 {
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.y(), !dbg !1201
  ret i32 %0, !dbg !1202
}

; Function Attrs: alwaysinline convergent mustprogress nounwind
define linkonce_odr dso_local noundef i32 @_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_yEv() #2 comdat align 2 !dbg !1203 {
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ntid.y(), !dbg !1204
  ret i32 %0, !dbg !1205
}
...
!1010 = !{i32 2, i32 0}
!1011 = distinct !DISubprogram(name: "Fan1", linkageName: "_Z4Fan1PfS_ii", scope: !1012, file: !1012, line: 318, type: !1013, scopeLine: 319, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, retainedNodes: !1015)
!1012 = !DIFile(filename: "./gaussian.cu", directory: "/nethome/cahn45/CuPBoP/examples/gauss")
!1013 = !DISubroutineType(types: !1014)
!1014 = !{null, !296, !296, !160, !160}
!1015 = !{}
!1016 = !DILocalVariable(name: "m_cuda", arg: 1, scope: !1011, file: !1012, line: 318, type: !296)
!1017 = !DILocation(line: 318, column: 42, scope: !1011)
!1018 = !DILocalVariable(name: "a_cuda", arg: 2, scope: !1011, file: !1012, line: 318, type: !296)
!1019 = !DILocation(line: 318, column: 57, scope: !1011)
!1020 = !DILocalVariable(name: "Size", arg: 3, scope: !1011, file: !1012, line: 318, type: !160)
!1021 = !DILocation(line: 318, column: 69, scope: !1011)
!1022 = !DILocalVariable(name: "t", arg: 4, scope: !1011, file: !1012, line: 318, type: !160)
!1023 = !DILocation(line: 318, column: 79, scope: !1011)
!1024 = !DILocation(line: 323, column: 5, scope: !1025)
!1025 = distinct !DILexicalBlock(scope: !1011, file: !1012, line: 323, column: 5)
!1026 = !DILocation(line: 323, column: 19, scope: !1025)
!1027 = !DILocation(line: 323, column: 32, scope: !1025)
!1028 = !DILocation(line: 323, column: 30, scope: !1025)
!1029 = !DILocation(line: 323, column: 17, scope: !1025)
!1030 = !DILocation(line: 323, column: 46, scope: !1025)
!1031 = !DILocation(line: 323, column: 50, scope: !1025)
!1032 = !DILocation(line: 323, column: 53, scope: !1025)
!1033 = !DILocation(line: 323, column: 52, scope: !1025)
!1034 = !DILocation(line: 323, column: 43, scope: !1025)
!1035 = !DILocation(line: 323, column: 5, scope: !1011)
!1036 = !DILocation(line: 323, column: 56, scope: !1025)
!1037 = !DILocation(line: 324, column: 63, scope: !1011)
!1038 = !DILocation(line: 324, column: 70, scope: !1011)
!1039 = !DILocation(line: 324, column: 76, scope: !1011)
!1040 = !DILocation(line: 324, column: 87, scope: !1011)
!1041 = !DILocation(line: 324, column: 86, scope: !1011)
!1042 = !DILocation(line: 324, column: 98, scope: !1011)
!1043 = !DILocation(line: 324, column: 97, scope: !1011)
!1044 = !DILocation(line: 324, column: 110, scope: !1011)
!1045 = !DILocation(line: 324, column: 109, scope: !1011)
!1046 = !DILocation(line: 324, column: 111, scope: !1011)
!1047 = !DILocation(line: 324, column: 74, scope: !1011)
!1048 = !DILocation(line: 324, column: 69, scope: !1011)
!1049 = !DILocation(line: 324, column: 115, scope: !1011)
!1050 = !DILocation(line: 324, column: 114, scope: !1011)
!1051 = !DILocation(line: 324, column: 61, scope: !1011)
!1052 = !DILocation(line: 324, column: 122, scope: !1011)
!1053 = !DILocation(line: 324, column: 129, scope: !1011)
!1054 = !DILocation(line: 324, column: 134, scope: !1011)
!1055 = !DILocation(line: 324, column: 133, scope: !1011)
!1056 = !DILocation(line: 324, column: 128, scope: !1011)
!1057 = !DILocation(line: 324, column: 136, scope: !1011)
!1058 = !DILocation(line: 324, column: 135, scope: !1011)
!1059 = !DILocation(line: 324, column: 120, scope: !1011)
!1060 = !DILocation(line: 324, column: 118, scope: !1011)
!1061 = !DILocation(line: 324, column: 4, scope: !1011)
!1062 = !DILocation(line: 324, column: 11, scope: !1011)
!1063 = !DILocation(line: 324, column: 17, scope: !1011)
!1064 = !DILocation(line: 324, column: 28, scope: !1011)
!1065 = !DILocation(line: 324, column: 27, scope: !1011)
!1066 = !DILocation(line: 324, column: 39, scope: !1011)
!1067 = !DILocation(line: 324, column: 38, scope: !1011)
!1068 = !DILocation(line: 324, column: 51, scope: !1011)
!1069 = !DILocation(line: 324, column: 50, scope: !1011)
!1070 = !DILocation(line: 324, column: 52, scope: !1011)
!1071 = !DILocation(line: 324, column: 15, scope: !1011)
!1072 = !DILocation(line: 324, column: 10, scope: !1011)
!1073 = !DILocation(line: 324, column: 56, scope: !1011)
!1074 = !DILocation(line: 324, column: 55, scope: !1011)
!1075 = !DILocation(line: 324, column: 59, scope: !1011)
!1076 = !DILocation(line: 325, column: 1, scope: !1011)
!1077 = distinct !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_xEv", scope: !66, file: !67, line: 53, type: !70, scopeLine: 53, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, declaration: !69)
!1078 = !DILocation(line: 53, column: 180, scope: !1077)
!1079 = !DILocation(line: 53, column: 173, scope: !1077)
!1080 = distinct !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_xEv", scope: !97, file: !67, line: 66, type: !70, scopeLine: 66, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, declaration: !99)
!1081 = !DILocation(line: 66, column: 180, scope: !1080)
!1082 = !DILocation(line: 66, column: 173, scope: !1080)
!1083 = distinct !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_xEv", scope: !125, file: !67, line: 79, type: !70, scopeLine: 79, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, declaration: !127)
!1084 = !DILocation(line: 79, column: 180, scope: !1083)
!1085 = !DILocation(line: 79, column: 173, scope: !1083)
!1086 = distinct !DISubprogram(name: "Fan2", linkageName: "_Z4Fan2PfS_S_iii", scope: !1012, file: !1012, line: 332, type: !1087, scopeLine: 333, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, retainedNodes: !1015)
!1087 = !DISubroutineType(types: !1088)
!1088 = !{null, !296, !296, !296, !160, !160, !160}
!1089 = !DILocalVariable(name: "m_cuda", arg: 1, scope: !1086, file: !1012, line: 332, type: !296)
!1090 = !DILocation(line: 332, column: 42, scope: !1086)
!1091 = !DILocalVariable(name: "a_cuda", arg: 2, scope: !1086, file: !1012, line: 332, type: !296)
!1092 = !DILocation(line: 332, column: 57, scope: !1086)
!1093 = !DILocalVariable(name: "b_cuda", arg: 3, scope: !1086, file: !1012, line: 332, type: !296)
!1094 = !DILocation(line: 332, column: 72, scope: !1086)
!1095 = !DILocalVariable(name: "Size", arg: 4, scope: !1086, file: !1012, line: 332, type: !160)
!1096 = !DILocation(line: 332, column: 83, scope: !1086)
!1097 = !DILocalVariable(name: "j1", arg: 5, scope: !1086, file: !1012, line: 332, type: !160)
!1098 = !DILocation(line: 332, column: 93, scope: !1086)
!1099 = !DILocalVariable(name: "t", arg: 6, scope: !1086, file: !1012, line: 332, type: !160)
!1100 = !DILocation(line: 332, column: 101, scope: !1086)
!1101 = !DILocation(line: 334, column: 5, scope: !1102)
!1102 = distinct !DILexicalBlock(scope: !1086, file: !1012, line: 334, column: 5)
!1103 = !DILocation(line: 334, column: 19, scope: !1102)
!1104 = !DILocation(line: 334, column: 32, scope: !1102)
!1105 = !DILocation(line: 334, column: 30, scope: !1102)
!1106 = !DILocation(line: 334, column: 17, scope: !1102)
!1107 = !DILocation(line: 334, column: 46, scope: !1102)
!1108 = !DILocation(line: 334, column: 50, scope: !1102)
!1109 = !DILocation(line: 334, column: 53, scope: !1102)
!1110 = !DILocation(line: 334, column: 52, scope: !1102)
!1111 = !DILocation(line: 334, column: 43, scope: !1102)
!1112 = !DILocation(line: 334, column: 5, scope: !1086)
!1113 = !DILocation(line: 334, column: 56, scope: !1102)
!1114 = !DILocation(line: 335, column: 5, scope: !1115)
!1115 = distinct !DILexicalBlock(scope: !1086, file: !1012, line: 335, column: 5)
!1116 = !DILocation(line: 335, column: 19, scope: !1115)
!1117 = !DILocation(line: 335, column: 32, scope: !1115)
!1118 = !DILocation(line: 335, column: 30, scope: !1115)
!1119 = !DILocation(line: 335, column: 17, scope: !1115)
!1120 = !DILocation(line: 335, column: 46, scope: !1115)
!1121 = !DILocation(line: 335, column: 51, scope: !1115)
!1122 = !DILocation(line: 335, column: 50, scope: !1115)
!1123 = !DILocation(line: 335, column: 43, scope: !1115)
!1124 = !DILocation(line: 335, column: 5, scope: !1086)
!1125 = !DILocation(line: 335, column: 54, scope: !1115)
!1126 = !DILocalVariable(name: "xidx", scope: !1086, file: !1012, line: 337, type: !160)
!1127 = !DILocation(line: 337, column: 6, scope: !1086)
!1128 = !DILocation(line: 337, column: 13, scope: !1086)
!1129 = !DILocation(line: 337, column: 26, scope: !1086)
!1130 = !DILocation(line: 337, column: 24, scope: !1086)
!1131 = !DILocation(line: 337, column: 39, scope: !1086)
!1132 = !DILocation(line: 337, column: 37, scope: !1086)
!1133 = !DILocalVariable(name: "yidx", scope: !1086, file: !1012, line: 338, type: !160)
!1134 = !DILocation(line: 338, column: 6, scope: !1086)
!1135 = !DILocation(line: 338, column: 13, scope: !1086)
!1136 = !DILocation(line: 338, column: 26, scope: !1086)
!1137 = !DILocation(line: 338, column: 24, scope: !1086)
!1138 = !DILocation(line: 338, column: 39, scope: !1086)
!1139 = !DILocation(line: 338, column: 37, scope: !1086)
!1140 = !DILocation(line: 341, column: 38, scope: !1086)
!1141 = !DILocation(line: 341, column: 45, scope: !1086)
!1142 = !DILocation(line: 341, column: 51, scope: !1086)
!1143 = !DILocation(line: 341, column: 55, scope: !1086)
!1144 = !DILocation(line: 341, column: 58, scope: !1086)
!1145 = !DILocation(line: 341, column: 57, scope: !1086)
!1146 = !DILocation(line: 341, column: 49, scope: !1086)
!1147 = !DILocation(line: 341, column: 61, scope: !1086)
!1148 = !DILocation(line: 341, column: 60, scope: !1086)
!1149 = !DILocation(line: 341, column: 66, scope: !1086)
!1150 = !DILocation(line: 341, column: 73, scope: !1086)
!1151 = !DILocation(line: 341, column: 78, scope: !1086)
!1152 = !DILocation(line: 341, column: 77, scope: !1086)
!1153 = !DILocation(line: 341, column: 81, scope: !1086)
!1154 = !DILocation(line: 341, column: 86, scope: !1086)
!1155 = !DILocation(line: 341, column: 85, scope: !1086)
!1156 = !DILocation(line: 341, column: 79, scope: !1086)
!1157 = !DILocation(line: 341, column: 64, scope: !1086)
!1158 = !DILocation(line: 341, column: 2, scope: !1086)
!1159 = !DILocation(line: 341, column: 9, scope: !1086)
!1160 = !DILocation(line: 341, column: 15, scope: !1086)
!1161 = !DILocation(line: 341, column: 19, scope: !1086)
!1162 = !DILocation(line: 341, column: 22, scope: !1086)
!1163 = !DILocation(line: 341, column: 21, scope: !1086)
!1164 = !DILocation(line: 341, column: 13, scope: !1086)
!1165 = !DILocation(line: 341, column: 26, scope: !1086)
!1166 = !DILocation(line: 341, column: 31, scope: !1086)
!1167 = !DILocation(line: 341, column: 30, scope: !1086)
!1168 = !DILocation(line: 341, column: 24, scope: !1086)
!1169 = !DILocation(line: 341, column: 35, scope: !1086)
!1170 = !DILocation(line: 343, column: 5, scope: !1171)
!1171 = distinct !DILexicalBlock(scope: !1086, file: !1012, line: 343, column: 5)
!1172 = !DILocation(line: 343, column: 10, scope: !1171)
!1173 = !DILocation(line: 343, column: 5, scope: !1086)
!1174 = !DILocation(line: 346, column: 23, scope: !1175)
!1175 = distinct !DILexicalBlock(scope: !1171, file: !1012, line: 343, column: 15)
!1176 = !DILocation(line: 346, column: 30, scope: !1175)
!1177 = !DILocation(line: 346, column: 36, scope: !1175)
!1178 = !DILocation(line: 346, column: 40, scope: !1175)
!1179 = !DILocation(line: 346, column: 43, scope: !1175)
!1180 = !DILocation(line: 346, column: 42, scope: !1175)
!1181 = !DILocation(line: 346, column: 34, scope: !1175)
!1182 = !DILocation(line: 346, column: 47, scope: !1175)
!1183 = !DILocation(line: 346, column: 52, scope: !1175)
!1184 = !DILocation(line: 346, column: 51, scope: !1175)
!1185 = !DILocation(line: 346, column: 45, scope: !1175)
!1186 = !DILocation(line: 346, column: 58, scope: !1175)
!1187 = !DILocation(line: 346, column: 65, scope: !1175)
!1188 = !DILocation(line: 346, column: 56, scope: !1175)
!1189 = !DILocation(line: 346, column: 3, scope: !1175)
!1190 = !DILocation(line: 346, column: 10, scope: !1175)
!1191 = !DILocation(line: 346, column: 14, scope: !1175)
!1192 = !DILocation(line: 346, column: 17, scope: !1175)
!1193 = !DILocation(line: 346, column: 16, scope: !1175)
!1194 = !DILocation(line: 346, column: 20, scope: !1175)
!1195 = !DILocation(line: 347, column: 2, scope: !1175)
!1196 = !DILocation(line: 348, column: 1, scope: !1086)
!1197 = distinct !DISubprogram(name: "__fetch_builtin_y", linkageName: "_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_yEv", scope: !66, file: !67, line: 54, type: !70, scopeLine: 54, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, declaration: !72)
!1198 = !DILocation(line: 54, column: 180, scope: !1197)
!1199 = !DILocation(line: 54, column: 173, scope: !1197)
!1200 = distinct !DISubprogram(name: "__fetch_builtin_y", linkageName: "_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_yEv", scope: !97, file: !67, line: 67, type: !70, scopeLine: 67, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, declaration: !100)
!1201 = !DILocation(line: 67, column: 180, scope: !1200)
!1202 = !DILocation(line: 67, column: 173, scope: !1200)
!1203 = distinct !DISubprogram(name: "__fetch_builtin_y", linkageName: "_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_yEv", scope: !125, file: !67, line: 80, type: !70, scopeLine: 80, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, declaration: !128)
!1204 = !DILocation(line: 80, column: 180, scope: !1203)
!1205 = !DILocation(line: 80, column: 173, scope: !1203)
