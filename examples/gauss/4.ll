...
entry_after_block_sync_1:                         ; preds = %entry_after_block_sync_2
  ...
  call void @llvm.dbg.declare(metadata ptr %m_cuda.addr, metadata !1011, metadata !DIExpression()), !dbg !1017
  store ptr %a_cuda, ptr %a_cuda.addr, align 8
  call void @llvm.dbg.declare(metadata ptr %a_cuda.addr, metadata !1018, metadata !DIExpression()), !dbg !1019
  store i32 %Size, ptr %Size.addr, align 4
  call void @llvm.dbg.declare(metadata ptr %Size.addr, metadata !1020, metadata !DIExpression()), !dbg !1021
  store i32 %t, ptr %t.addr, align 4
  call void @llvm.dbg.declare(metadata ptr %t.addr, metadata !1022, metadata !DIExpression()), !dbg !1023
  %0 = call noundef i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !dbg !1024
  %1 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !dbg !1028
  %2 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ntid.x(), !dbg !1031
  %mul = mul i32 %1, %2, !dbg !1034
  %add = add i32 %0, %mul, !dbg !1035
  %3 = load i32, ptr %Size.addr, align 4, !dbg !1036
  %sub = sub nsw i32 %3, 1, !dbg !1037
  %4 = load i32, ptr %t.addr, align 4, !dbg !1038
  %sub3 = sub nsw i32 %sub, %4, !dbg !1039
  %cmp = icmp uge i32 %add, %sub3, !dbg !1040
...
if.end:                                           ; preds = %entry_after_block_sync_1
  %5 = load ptr, ptr %a_cuda.addr, align 8, !dbg !1043
  %6 = load i32, ptr %Size.addr, align 4, !dbg !1044
  %7 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ntid.x(), !dbg !1045
  %8 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !dbg !1047
  %mul6 = mul i32 %7, %8, !dbg !1049
  %9 = call noundef i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !dbg !1050
  %add8 = add i32 %mul6, %9, !dbg !1052
  %10 = load i32, ptr %t.addr, align 4, !dbg !1053
  %add9 = add i32 %add8, %10, !dbg !1054
  %add10 = add i32 %add9, 1, !dbg !1055
  %mul11 = mul i32 %6, %add10, !dbg !1056
  %idx.ext = zext i32 %mul11 to i64, !dbg !1057
  %add.ptr = getelementptr inbounds float, ptr %5, i64 %idx.ext, !dbg !1057
  %11 = load i32, ptr %t.addr, align 4, !dbg !1058
  %idx.ext12 = sext i32 %11 to i64, !dbg !1059
  %add.ptr13 = getelementptr inbounds float, ptr %add.ptr, i64 %idx.ext12, !dbg !1059
  %12 = load float, ptr %add.ptr13, align 4, !dbg !1060
  %13 = load ptr, ptr %a_cuda.addr, align 8, !dbg !1061
  %14 = load i32, ptr %Size.addr, align 4, !dbg !1062
  %15 = load i32, ptr %t.addr, align 4, !dbg !1063
  %mul14 = mul nsw i32 %14, %15, !dbg !1064
  %idx.ext15 = sext i32 %mul14 to i64, !dbg !1065
  %add.ptr16 = getelementptr inbounds float, ptr %13, i64 %idx.ext15, !dbg !1065
  %16 = load i32, ptr %t.addr, align 4, !dbg !1066
  %idx.ext17 = sext i32 %16 to i64, !dbg !1067
  %add.ptr18 = getelementptr inbounds float, ptr %add.ptr16, i64 %idx.ext17, !dbg !1067
  %17 = load float, ptr %add.ptr18, align 4, !dbg !1068
  %div = fdiv contract float %12, %17, !dbg !1069
  %18 = load ptr, ptr %m_cuda.addr, align 8, !dbg !1070
  %19 = load i32, ptr %Size.addr, align 4, !dbg !1071
  %20 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ntid.x(), !dbg !1072
  %21 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !dbg !1074
  %mul21 = mul i32 %20, %21, !dbg !1076
  %22 = call noundef i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !dbg !1077
  %add23 = add i32 %mul21, %22, !dbg !1079
  %23 = load i32, ptr %t.addr, align 4, !dbg !1080
  %add24 = add i32 %add23, %23, !dbg !1081
  %add25 = add i32 %add24, 1, !dbg !1082
  %mul26 = mul i32 %19, %add25, !dbg !1083
  %idx.ext27 = zext i32 %mul26 to i64, !dbg !1084
  %add.ptr28 = getelementptr inbounds float, ptr %18, i64 %idx.ext27, !dbg !1084
  %24 = load i32, ptr %t.addr, align 4, !dbg !1085
  %idx.ext29 = sext i32 %24 to i64, !dbg !1086
  %add.ptr30 = getelementptr inbounds float, ptr %add.ptr28, i64 %idx.ext29, !dbg !1086
  store float %div, ptr %add.ptr30, align 4, !dbg !1087
  br label %return, !dbg !1088

return:                                           ; preds = %if.end, %if.then
  br label %return_after_block_sync_3

return_after_block_sync_3:                        ; preds = %return
  call void @llvm.nvvm.barrier0()
  br label %return_after_block_sync_0, !dbg !1088
...
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !dbg !1089
  ret i32 %0, !dbg !1090
}
...
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !dbg !1091
  ret i32 %0, !dbg !1092
}
...
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ntid.x(), !dbg !1093
  ret i32 %0, !dbg !1094
}
...
entry_after_block_sync_1:                         ; preds = %entry_after_block_sync_2
  store ptr %m_cuda, ptr %m_cuda.addr, align 8
  call void @llvm.dbg.declare(metadata ptr %m_cuda.addr, metadata !1095, metadata !DIExpression()), !dbg !1099
  store ptr %a_cuda, ptr %a_cuda.addr, align 8
  call void @llvm.dbg.declare(metadata ptr %a_cuda.addr, metadata !1100, metadata !DIExpression()), !dbg !1101
  store ptr %b_cuda, ptr %b_cuda.addr, align 8
  call void @llvm.dbg.declare(metadata ptr %b_cuda.addr, metadata !1102, metadata !DIExpression()), !dbg !1103
  store i32 %Size, ptr %Size.addr, align 4
  call void @llvm.dbg.declare(metadata ptr %Size.addr, metadata !1104, metadata !DIExpression()), !dbg !1105
  store i32 %j1, ptr %j1.addr, align 4
  call void @llvm.dbg.declare(metadata ptr %j1.addr, metadata !1106, metadata !DIExpression()), !dbg !1107
  store i32 %t, ptr %t.addr, align 4
  call void @llvm.dbg.declare(metadata ptr %t.addr, metadata !1108, metadata !DIExpression()), !dbg !1109
  %0 = call noundef i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !dbg !1110
  %1 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !dbg !1113
  %2 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ntid.x(), !dbg !1115
  %mul = mul i32 %1, %2, !dbg !1117
  %add = add i32 %0, %mul, !dbg !1118
  %3 = load i32, ptr %Size.addr, align 4, !dbg !1119
  %sub = sub nsw i32 %3, 1, !dbg !1120
  %4 = load i32, ptr %t.addr, align 4, !dbg !1121
  %sub3 = sub nsw i32 %sub, %4, !dbg !1122
  %cmp = icmp uge i32 %add, %sub3, !dbg !1123
...
if.end:                                           ; preds = %entry_after_block_sync_1
  %5 = call noundef i32 @llvm.nvvm.read.ptx.sreg.tid.y(), !dbg !1126
  %6 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ctaid.y(), !dbg !1130
  %7 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ntid.y(), !dbg !1133
  %mul7 = mul i32 %6, %7, !dbg !1136
  %add8 = add i32 %5, %mul7, !dbg !1137
  %8 = load i32, ptr %Size.addr, align 4, !dbg !1138
  %9 = load i32, ptr %t.addr, align 4, !dbg !1139
  %sub9 = sub nsw i32 %8, %9, !dbg !1140
  %cmp10 = icmp uge i32 %add8, %sub9, !dbg !1141
  br i1 %cmp10, label %if.then11, label %if.end12, !dbg !1142

if.then11:                                        ; preds = %if.end
  br label %if.end58, !dbg !1143

if.end12:                                         ; preds = %if.end
  call void @llvm.dbg.declare(metadata ptr %xidx, metadata !1144, metadata !DIExpression()), !dbg !1145
  %10 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !dbg !1146
  %11 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ntid.x(), !dbg !1148
  %mul15 = mul i32 %10, %11, !dbg !1150
  %12 = call noundef i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !dbg !1151
  %add17 = add i32 %mul15, %12, !dbg !1153
  store i32 %add17, ptr %xidx, align 4, !dbg !1145
  call void @llvm.dbg.declare(metadata ptr %yidx, metadata !1154, metadata !DIExpression()), !dbg !1155
  %13 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ctaid.y(), !dbg !1156
  %14 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ntid.y(), !dbg !1158
  %mul20 = mul i32 %13, %14, !dbg !1160
  %15 = call noundef i32 @llvm.nvvm.read.ptx.sreg.tid.y(), !dbg !1161
  %add22 = add i32 %mul20, %15, !dbg !1163
  store i32 %add22, ptr %yidx, align 4, !dbg !1155
  %16 = load ptr, ptr %m_cuda.addr, align 8, !dbg !1164
  %17 = load i32, ptr %Size.addr, align 4, !dbg !1165
  %18 = load i32, ptr %xidx, align 4, !dbg !1166
  %add23 = add nsw i32 %18, 1, !dbg !1167
  %19 = load i32, ptr %t.addr, align 4, !dbg !1168
  %add24 = add nsw i32 %add23, %19, !dbg !1169
  %mul25 = mul nsw i32 %17, %add24, !dbg !1170
  %20 = load i32, ptr %t.addr, align 4, !dbg !1171
  %add26 = add nsw i32 %mul25, %20, !dbg !1172
  %idxprom = sext i32 %add26 to i64, !dbg !1164
  %arrayidx = getelementptr inbounds float, ptr %16, i64 %idxprom, !dbg !1164
  %21 = load float, ptr %arrayidx, align 4, !dbg !1164
  %22 = load ptr, ptr %a_cuda.addr, align 8, !dbg !1173
  %23 = load i32, ptr %Size.addr, align 4, !dbg !1174
  %24 = load i32, ptr %t.addr, align 4, !dbg !1175
  %mul27 = mul nsw i32 %23, %24, !dbg !1176
  %25 = load i32, ptr %yidx, align 4, !dbg !1177
  %26 = load i32, ptr %t.addr, align 4, !dbg !1178
  %add28 = add nsw i32 %25, %26, !dbg !1179
  %add29 = add nsw i32 %mul27, %add28, !dbg !1180
  %idxprom30 = sext i32 %add29 to i64, !dbg !1173
  %arrayidx31 = getelementptr inbounds float, ptr %22, i64 %idxprom30, !dbg !1173
  %27 = load float, ptr %arrayidx31, align 4, !dbg !1173
  %mul32 = fmul contract float %21, %27, !dbg !1181
  %28 = load ptr, ptr %a_cuda.addr, align 8, !dbg !1182
  %29 = load i32, ptr %Size.addr, align 4, !dbg !1183
  %30 = load i32, ptr %xidx, align 4, !dbg !1184
  %add33 = add nsw i32 %30, 1, !dbg !1185
  %31 = load i32, ptr %t.addr, align 4, !dbg !1186
  %add34 = add nsw i32 %add33, %31, !dbg !1187
  %mul35 = mul nsw i32 %29, %add34, !dbg !1188
  %32 = load i32, ptr %yidx, align 4, !dbg !1189
  %33 = load i32, ptr %t.addr, align 4, !dbg !1190
  %add36 = add nsw i32 %32, %33, !dbg !1191
  %add37 = add nsw i32 %mul35, %add36, !dbg !1192
  %idxprom38 = sext i32 %add37 to i64, !dbg !1182
  %arrayidx39 = getelementptr inbounds float, ptr %28, i64 %idxprom38, !dbg !1182
  %34 = load float, ptr %arrayidx39, align 4, !dbg !1193
  %sub40 = fsub contract float %34, %mul32, !dbg !1193
  store float %sub40, ptr %arrayidx39, align 4, !dbg !1193
  %35 = load i32, ptr %yidx, align 4, !dbg !1194
  %cmp41 = icmp eq i32 %35, 0, !dbg !1196
  br i1 %cmp41, label %if.then42, label %if.end58, !dbg !1197

if.then42:                                        ; preds = %if.end12
  %36 = load ptr, ptr %m_cuda.addr, align 8, !dbg !1198
  %37 = load i32, ptr %Size.addr, align 4, !dbg !1200
  %38 = load i32, ptr %xidx, align 4, !dbg !1201
  %add43 = add nsw i32 %38, 1, !dbg !1202
  %39 = load i32, ptr %t.addr, align 4, !dbg !1203
  %add44 = add nsw i32 %add43, %39, !dbg !1204
  %mul45 = mul nsw i32 %37, %add44, !dbg !1205
  %40 = load i32, ptr %yidx, align 4, !dbg !1206
  %41 = load i32, ptr %t.addr, align 4, !dbg !1207
  %add46 = add nsw i32 %40, %41, !dbg !1208
  %add47 = add nsw i32 %mul45, %add46, !dbg !1209
  %idxprom48 = sext i32 %add47 to i64, !dbg !1198
  %arrayidx49 = getelementptr inbounds float, ptr %36, i64 %idxprom48, !dbg !1198
  %42 = load float, ptr %arrayidx49, align 4, !dbg !1198
  %43 = load ptr, ptr %b_cuda.addr, align 8, !dbg !1210
  %44 = load i32, ptr %t.addr, align 4, !dbg !1211
  %idxprom50 = sext i32 %44 to i64, !dbg !1210
  %arrayidx51 = getelementptr inbounds float, ptr %43, i64 %idxprom50, !dbg !1210
  %45 = load float, ptr %arrayidx51, align 4, !dbg !1210
  %mul52 = fmul contract float %42, %45, !dbg !1212
  %46 = load ptr, ptr %b_cuda.addr, align 8, !dbg !1213
  %47 = load i32, ptr %xidx, align 4, !dbg !1214
  %add53 = add nsw i32 %47, 1, !dbg !1215
  %48 = load i32, ptr %t.addr, align 4, !dbg !1216
  %add54 = add nsw i32 %add53, %48, !dbg !1217
  %idxprom55 = sext i32 %add54 to i64, !dbg !1213
  %arrayidx56 = getelementptr inbounds float, ptr %46, i64 %idxprom55, !dbg !1213
  %49 = load float, ptr %arrayidx56, align 4, !dbg !1218
  %sub57 = fsub contract float %49, %mul52, !dbg !1218
  store float %sub57, ptr %arrayidx56, align 4, !dbg !1218
  br label %if.end58, !dbg !1219

if.end58:                                         ; preds = %if.then, %if.then11, %if.then42, %if.end12
  br label %if.end58_after_block_sync_3

if.end58_after_block_sync_3:                      ; preds = %if.end58
  call void @llvm.nvvm.barrier0()
  br label %if.end58_after_block_sync_0, !dbg !1220
...
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.tid.y(), !dbg !1221
  ret i32 %0, !dbg !1222
}
...
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.y(), !dbg !1223
  ret i32 %0, !dbg !1224
}
...
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ntid.y(), !dbg !1225
  ret i32 %0, !dbg !1226
}
...
!1010 = !{i32 2, i32 0}
!1011 = !DILocalVariable(name: "m_cuda", arg: 1, scope: !1012, file: !1013, line: 318, type: !296)
!1012 = distinct !DISubprogram(name: "Fan1", linkageName: "_Z4Fan1PfS_ii", scope: !1013, file: !1013, line: 318, type: !1014, scopeLine: 319, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, retainedNodes: !1016)
!1013 = !DIFile(filename: "./gaussian.cu", directory: "/nethome/cahn45/CuPBoP/examples/gauss")
!1014 = !DISubroutineType(types: !1015)
!1015 = !{null, !296, !296, !160, !160}
!1016 = !{}
!1017 = !DILocation(line: 318, column: 42, scope: !1012)
!1018 = !DILocalVariable(name: "a_cuda", arg: 2, scope: !1012, file: !1013, line: 318, type: !296)
!1019 = !DILocation(line: 318, column: 57, scope: !1012)
!1020 = !DILocalVariable(name: "Size", arg: 3, scope: !1012, file: !1013, line: 318, type: !160)
!1021 = !DILocation(line: 318, column: 69, scope: !1012)
!1022 = !DILocalVariable(name: "t", arg: 4, scope: !1012, file: !1013, line: 318, type: !160)
!1023 = !DILocation(line: 318, column: 79, scope: !1012)
!1024 = !DILocation(line: 53, column: 180, scope: !1025, inlinedAt: !1026)
!1025 = distinct !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_xEv", scope: !66, file: !67, line: 53, type: !70, scopeLine: 53, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, declaration: !69)
!1026 = distinct !DILocation(line: 323, column: 5, scope: !1027)
!1027 = distinct !DILexicalBlock(scope: !1012, file: !1013, line: 323, column: 5)
!1028 = !DILocation(line: 66, column: 180, scope: !1029, inlinedAt: !1030)
!1029 = distinct !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_xEv", scope: !97, file: !67, line: 66, type: !70, scopeLine: 66, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, declaration: !99)
!1030 = distinct !DILocation(line: 323, column: 19, scope: !1027)
!1031 = !DILocation(line: 79, column: 180, scope: !1032, inlinedAt: !1033)
!1032 = distinct !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_xEv", scope: !125, file: !67, line: 79, type: !70, scopeLine: 79, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, declaration: !127)
!1033 = distinct !DILocation(line: 323, column: 32, scope: !1027)
!1034 = !DILocation(line: 323, column: 30, scope: !1027)
!1035 = !DILocation(line: 323, column: 17, scope: !1027)
!1036 = !DILocation(line: 323, column: 46, scope: !1027)
!1037 = !DILocation(line: 323, column: 50, scope: !1027)
!1038 = !DILocation(line: 323, column: 53, scope: !1027)
!1039 = !DILocation(line: 323, column: 52, scope: !1027)
!1040 = !DILocation(line: 323, column: 43, scope: !1027)
!1041 = !DILocation(line: 323, column: 5, scope: !1012)
!1042 = !DILocation(line: 323, column: 56, scope: !1027)
!1043 = !DILocation(line: 324, column: 63, scope: !1012)
!1044 = !DILocation(line: 324, column: 70, scope: !1012)
!1045 = !DILocation(line: 79, column: 180, scope: !1032, inlinedAt: !1046)
!1046 = distinct !DILocation(line: 324, column: 76, scope: !1012)
!1047 = !DILocation(line: 66, column: 180, scope: !1029, inlinedAt: !1048)
!1048 = distinct !DILocation(line: 324, column: 87, scope: !1012)
!1049 = !DILocation(line: 324, column: 86, scope: !1012)
!1050 = !DILocation(line: 53, column: 180, scope: !1025, inlinedAt: !1051)
!1051 = distinct !DILocation(line: 324, column: 98, scope: !1012)
!1052 = !DILocation(line: 324, column: 97, scope: !1012)
!1053 = !DILocation(line: 324, column: 110, scope: !1012)
!1054 = !DILocation(line: 324, column: 109, scope: !1012)
!1055 = !DILocation(line: 324, column: 111, scope: !1012)
!1056 = !DILocation(line: 324, column: 74, scope: !1012)
!1057 = !DILocation(line: 324, column: 69, scope: !1012)
!1058 = !DILocation(line: 324, column: 115, scope: !1012)
!1059 = !DILocation(line: 324, column: 114, scope: !1012)
!1060 = !DILocation(line: 324, column: 61, scope: !1012)
!1061 = !DILocation(line: 324, column: 122, scope: !1012)
!1062 = !DILocation(line: 324, column: 129, scope: !1012)
!1063 = !DILocation(line: 324, column: 134, scope: !1012)
!1064 = !DILocation(line: 324, column: 133, scope: !1012)
!1065 = !DILocation(line: 324, column: 128, scope: !1012)
!1066 = !DILocation(line: 324, column: 136, scope: !1012)
!1067 = !DILocation(line: 324, column: 135, scope: !1012)
!1068 = !DILocation(line: 324, column: 120, scope: !1012)
!1069 = !DILocation(line: 324, column: 118, scope: !1012)
!1070 = !DILocation(line: 324, column: 4, scope: !1012)
!1071 = !DILocation(line: 324, column: 11, scope: !1012)
!1072 = !DILocation(line: 79, column: 180, scope: !1032, inlinedAt: !1073)
!1073 = distinct !DILocation(line: 324, column: 17, scope: !1012)
!1074 = !DILocation(line: 66, column: 180, scope: !1029, inlinedAt: !1075)
!1075 = distinct !DILocation(line: 324, column: 28, scope: !1012)
!1076 = !DILocation(line: 324, column: 27, scope: !1012)
!1077 = !DILocation(line: 53, column: 180, scope: !1025, inlinedAt: !1078)
!1078 = distinct !DILocation(line: 324, column: 39, scope: !1012)
!1079 = !DILocation(line: 324, column: 38, scope: !1012)
!1080 = !DILocation(line: 324, column: 51, scope: !1012)
!1081 = !DILocation(line: 324, column: 50, scope: !1012)
!1082 = !DILocation(line: 324, column: 52, scope: !1012)
!1083 = !DILocation(line: 324, column: 15, scope: !1012)
!1084 = !DILocation(line: 324, column: 10, scope: !1012)
!1085 = !DILocation(line: 324, column: 56, scope: !1012)
!1086 = !DILocation(line: 324, column: 55, scope: !1012)
!1087 = !DILocation(line: 324, column: 59, scope: !1012)
!1088 = !DILocation(line: 325, column: 1, scope: !1012)
!1089 = !DILocation(line: 53, column: 180, scope: !1025)
!1090 = !DILocation(line: 53, column: 173, scope: !1025)
!1091 = !DILocation(line: 66, column: 180, scope: !1029)
!1092 = !DILocation(line: 66, column: 173, scope: !1029)
!1093 = !DILocation(line: 79, column: 180, scope: !1032)
!1094 = !DILocation(line: 79, column: 173, scope: !1032)
!1095 = !DILocalVariable(name: "m_cuda", arg: 1, scope: !1096, file: !1013, line: 332, type: !296)
!1096 = distinct !DISubprogram(name: "Fan2", linkageName: "_Z4Fan2PfS_S_iii", scope: !1013, file: !1013, line: 332, type: !1097, scopeLine: 333, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, retainedNodes: !1016)
!1097 = !DISubroutineType(types: !1098)
!1098 = !{null, !296, !296, !296, !160, !160, !160}
!1099 = !DILocation(line: 332, column: 42, scope: !1096)
!1100 = !DILocalVariable(name: "a_cuda", arg: 2, scope: !1096, file: !1013, line: 332, type: !296)
!1101 = !DILocation(line: 332, column: 57, scope: !1096)
!1102 = !DILocalVariable(name: "b_cuda", arg: 3, scope: !1096, file: !1013, line: 332, type: !296)
!1103 = !DILocation(line: 332, column: 72, scope: !1096)
!1104 = !DILocalVariable(name: "Size", arg: 4, scope: !1096, file: !1013, line: 332, type: !160)
!1105 = !DILocation(line: 332, column: 83, scope: !1096)
!1106 = !DILocalVariable(name: "j1", arg: 5, scope: !1096, file: !1013, line: 332, type: !160)
!1107 = !DILocation(line: 332, column: 93, scope: !1096)
!1108 = !DILocalVariable(name: "t", arg: 6, scope: !1096, file: !1013, line: 332, type: !160)
!1109 = !DILocation(line: 332, column: 101, scope: !1096)
!1110 = !DILocation(line: 53, column: 180, scope: !1025, inlinedAt: !1111)
!1111 = distinct !DILocation(line: 334, column: 5, scope: !1112)
!1112 = distinct !DILexicalBlock(scope: !1096, file: !1013, line: 334, column: 5)
!1113 = !DILocation(line: 66, column: 180, scope: !1029, inlinedAt: !1114)
!1114 = distinct !DILocation(line: 334, column: 19, scope: !1112)
!1115 = !DILocation(line: 79, column: 180, scope: !1032, inlinedAt: !1116)
!1116 = distinct !DILocation(line: 334, column: 32, scope: !1112)
!1117 = !DILocation(line: 334, column: 30, scope: !1112)
!1118 = !DILocation(line: 334, column: 17, scope: !1112)
!1119 = !DILocation(line: 334, column: 46, scope: !1112)
!1120 = !DILocation(line: 334, column: 50, scope: !1112)
!1121 = !DILocation(line: 334, column: 53, scope: !1112)
!1122 = !DILocation(line: 334, column: 52, scope: !1112)
!1123 = !DILocation(line: 334, column: 43, scope: !1112)
!1124 = !DILocation(line: 334, column: 5, scope: !1096)
!1125 = !DILocation(line: 334, column: 56, scope: !1112)
!1126 = !DILocation(line: 54, column: 180, scope: !1127, inlinedAt: !1128)
!1127 = distinct !DISubprogram(name: "__fetch_builtin_y", linkageName: "_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_yEv", scope: !66, file: !67, line: 54, type: !70, scopeLine: 54, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, declaration: !72)
!1128 = distinct !DILocation(line: 335, column: 5, scope: !1129)
!1129 = distinct !DILexicalBlock(scope: !1096, file: !1013, line: 335, column: 5)
!1130 = !DILocation(line: 67, column: 180, scope: !1131, inlinedAt: !1132)
!1131 = distinct !DISubprogram(name: "__fetch_builtin_y", linkageName: "_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_yEv", scope: !97, file: !67, line: 67, type: !70, scopeLine: 67, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, declaration: !100)
!1132 = distinct !DILocation(line: 335, column: 19, scope: !1129)
!1133 = !DILocation(line: 80, column: 180, scope: !1134, inlinedAt: !1135)
!1134 = distinct !DISubprogram(name: "__fetch_builtin_y", linkageName: "_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_yEv", scope: !125, file: !67, line: 80, type: !70, scopeLine: 80, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, declaration: !128)
!1135 = distinct !DILocation(line: 335, column: 32, scope: !1129)
!1136 = !DILocation(line: 335, column: 30, scope: !1129)
!1137 = !DILocation(line: 335, column: 17, scope: !1129)
!1138 = !DILocation(line: 335, column: 46, scope: !1129)
!1139 = !DILocation(line: 335, column: 51, scope: !1129)
!1140 = !DILocation(line: 335, column: 50, scope: !1129)
!1141 = !DILocation(line: 335, column: 43, scope: !1129)
!1142 = !DILocation(line: 335, column: 5, scope: !1096)
!1143 = !DILocation(line: 335, column: 54, scope: !1129)
!1144 = !DILocalVariable(name: "xidx", scope: !1096, file: !1013, line: 337, type: !160)
!1145 = !DILocation(line: 337, column: 6, scope: !1096)
!1146 = !DILocation(line: 66, column: 180, scope: !1029, inlinedAt: !1147)
!1147 = distinct !DILocation(line: 337, column: 13, scope: !1096)
!1148 = !DILocation(line: 79, column: 180, scope: !1032, inlinedAt: !1149)
!1149 = distinct !DILocation(line: 337, column: 26, scope: !1096)
!1150 = !DILocation(line: 337, column: 24, scope: !1096)
!1151 = !DILocation(line: 53, column: 180, scope: !1025, inlinedAt: !1152)
!1152 = distinct !DILocation(line: 337, column: 39, scope: !1096)
!1153 = !DILocation(line: 337, column: 37, scope: !1096)
!1154 = !DILocalVariable(name: "yidx", scope: !1096, file: !1013, line: 338, type: !160)
!1155 = !DILocation(line: 338, column: 6, scope: !1096)
!1156 = !DILocation(line: 67, column: 180, scope: !1131, inlinedAt: !1157)
!1157 = distinct !DILocation(line: 338, column: 13, scope: !1096)
!1158 = !DILocation(line: 80, column: 180, scope: !1134, inlinedAt: !1159)
!1159 = distinct !DILocation(line: 338, column: 26, scope: !1096)
!1160 = !DILocation(line: 338, column: 24, scope: !1096)
!1161 = !DILocation(line: 54, column: 180, scope: !1127, inlinedAt: !1162)
!1162 = distinct !DILocation(line: 338, column: 39, scope: !1096)
!1163 = !DILocation(line: 338, column: 37, scope: !1096)
!1164 = !DILocation(line: 341, column: 38, scope: !1096)
!1165 = !DILocation(line: 341, column: 45, scope: !1096)
!1166 = !DILocation(line: 341, column: 51, scope: !1096)
!1167 = !DILocation(line: 341, column: 55, scope: !1096)
!1168 = !DILocation(line: 341, column: 58, scope: !1096)
!1169 = !DILocation(line: 341, column: 57, scope: !1096)
!1170 = !DILocation(line: 341, column: 49, scope: !1096)
!1171 = !DILocation(line: 341, column: 61, scope: !1096)
!1172 = !DILocation(line: 341, column: 60, scope: !1096)
!1173 = !DILocation(line: 341, column: 66, scope: !1096)
!1174 = !DILocation(line: 341, column: 73, scope: !1096)
!1175 = !DILocation(line: 341, column: 78, scope: !1096)
!1176 = !DILocation(line: 341, column: 77, scope: !1096)
!1177 = !DILocation(line: 341, column: 81, scope: !1096)
!1178 = !DILocation(line: 341, column: 86, scope: !1096)
!1179 = !DILocation(line: 341, column: 85, scope: !1096)
!1180 = !DILocation(line: 341, column: 79, scope: !1096)
!1181 = !DILocation(line: 341, column: 64, scope: !1096)
!1182 = !DILocation(line: 341, column: 2, scope: !1096)
!1183 = !DILocation(line: 341, column: 9, scope: !1096)
!1184 = !DILocation(line: 341, column: 15, scope: !1096)
!1185 = !DILocation(line: 341, column: 19, scope: !1096)
!1186 = !DILocation(line: 341, column: 22, scope: !1096)
!1187 = !DILocation(line: 341, column: 21, scope: !1096)
!1188 = !DILocation(line: 341, column: 13, scope: !1096)
!1189 = !DILocation(line: 341, column: 26, scope: !1096)
!1190 = !DILocation(line: 341, column: 31, scope: !1096)
!1191 = !DILocation(line: 341, column: 30, scope: !1096)
!1192 = !DILocation(line: 341, column: 24, scope: !1096)
!1193 = !DILocation(line: 341, column: 35, scope: !1096)
!1194 = !DILocation(line: 343, column: 5, scope: !1195)
!1195 = distinct !DILexicalBlock(scope: !1096, file: !1013, line: 343, column: 5)
!1196 = !DILocation(line: 343, column: 10, scope: !1195)
!1197 = !DILocation(line: 343, column: 5, scope: !1096)
!1198 = !DILocation(line: 346, column: 23, scope: !1199)
!1199 = distinct !DILexicalBlock(scope: !1195, file: !1013, line: 343, column: 15)
!1200 = !DILocation(line: 346, column: 30, scope: !1199)
!1201 = !DILocation(line: 346, column: 36, scope: !1199)
!1202 = !DILocation(line: 346, column: 40, scope: !1199)
!1203 = !DILocation(line: 346, column: 43, scope: !1199)
!1204 = !DILocation(line: 346, column: 42, scope: !1199)
!1205 = !DILocation(line: 346, column: 34, scope: !1199)
!1206 = !DILocation(line: 346, column: 47, scope: !1199)
!1207 = !DILocation(line: 346, column: 52, scope: !1199)
!1208 = !DILocation(line: 346, column: 51, scope: !1199)
!1209 = !DILocation(line: 346, column: 45, scope: !1199)
!1210 = !DILocation(line: 346, column: 58, scope: !1199)
!1211 = !DILocation(line: 346, column: 65, scope: !1199)
!1212 = !DILocation(line: 346, column: 56, scope: !1199)
!1213 = !DILocation(line: 346, column: 3, scope: !1199)
!1214 = !DILocation(line: 346, column: 10, scope: !1199)
!1215 = !DILocation(line: 346, column: 14, scope: !1199)
!1216 = !DILocation(line: 346, column: 17, scope: !1199)
!1217 = !DILocation(line: 346, column: 16, scope: !1199)
!1218 = !DILocation(line: 346, column: 20, scope: !1199)
!1219 = !DILocation(line: 347, column: 2, scope: !1199)
!1220 = !DILocation(line: 348, column: 1, scope: !1096)
!1221 = !DILocation(line: 54, column: 180, scope: !1127)
!1222 = !DILocation(line: 54, column: 173, scope: !1127)
!1223 = !DILocation(line: 67, column: 180, scope: !1131)
!1224 = !DILocation(line: 67, column: 173, scope: !1131)
!1225 = !DILocation(line: 80, column: 180, scope: !1134)
!1226 = !DILocation(line: 80, column: 173, scope: !1134)
