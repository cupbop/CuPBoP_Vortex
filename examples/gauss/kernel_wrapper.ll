...
@callbacks = dso_local global [2 x ptr] [ptr @_Z23cuda_Fan1PfS_ii_wrapperPv, ptr @_Z26cuda_Fan2PfS_S_iii_wrapperPv], align 8
...
; Function Attrs: mustprogress nounwind uwtable
define dso_local void @_Z23cuda_Fan1PfS_ii_wrapperPv(ptr noundef %args) #1 {
entry:
  ...
  call void @Fan1PfS_ii_wrapper(ptr noundef %18)
  ret void
}

declare dso_local void @Fan1PfS_ii_wrapper(ptr noundef) #4

; Function Attrs: mustprogress nounwind uwtable
define dso_local void @_Z26cuda_Fan2PfS_S_iii_wrapperPv(ptr noundef %args) #1 {
entry:
  %args.addr = alloca ptr, align 8
  store ptr %args, ptr %args.addr, align 8, !tbaa !16
  %0 = call align 4 ptr @llvm.threadlocal.address.p0(ptr align 4 @blockIdx)
  ...
  store i32 %16, ptr %17, align 4, !tbaa !8
  %18 = load ptr, ptr %args.addr, align 8, !tbaa !16
  call void @Fan2PfS_S_iii_wrapper(ptr noundef %18)
  ret void
}

declare dso_local void @Fan2PfS_S_iii_wrapper(ptr noundef) #4
