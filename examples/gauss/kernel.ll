...
define dso_local void @_Z4Fan1PfS_ii(ptr noalias noundef %m_cuda, ptr noalias noundef %a_cuda, i32 noundef %Size, i32 noundef %t) local_unnamed_addr #0 {
entry:
  %0 = load i32, ptr @block_size, align 4
  %.not = icmp eq i32 %0, 0
  br i1 %.not, label %intra_reset_block, label %entry_after_block_sync_1.lr.ph, !llvm.loop !1011
...
entry_after_block_sync_1.lr.ph:                   ; preds = %entry
  ...
  %invariant.gep = getelementptr float, ptr %a_cuda, i64 %idx.ext12
  %mul14 = mul nsw i32 %t, %Size
  %idx.ext15 = sext i32 %mul14 to i64
  %add.ptr16 = getelementptr inbounds float, ptr %a_cuda, i64 %idx.ext15
  %add.ptr18 = getelementptr inbounds float, ptr %add.ptr16, i64 %idx.ext12
  %invariant.gep22 = getelementptr float, ptr %m_cuda, i64 %idx.ext12
  br label %entry_after_block_sync_1

entry_after_block_sync_1:                         ; preds = %return, %entry_after_block_sync_1.lr.ph
  %local_intra_warp_idx.021 = phi i32 [ 0, %entry_after_block_sync_1.lr.ph ], [ %intra_warp_index_increment, %return ]
  tail call void @llvm.dbg.value(metadata ptr %m_cuda, metadata !1014, metadata !DIExpression()), !dbg !1020
  tail call void @llvm.dbg.value(metadata ptr %a_cuda, metadata !1021, metadata !DIExpression()), !dbg !1020
  tail call void @llvm.dbg.value(metadata i32 %Size, metadata !1022, metadata !DIExpression()), !dbg !1020
  tail call void @llvm.dbg.value(metadata i32 %t, metadata !1023, metadata !DIExpression()), !dbg !1020
  %thread_id_x = srem i32 %local_intra_warp_idx.021, %1, !dbg !1024
  %add = add i32 %mul, %thread_id_x, !dbg !1028
  %cmp.not = icmp ult i32 %add, %sub3, !dbg !1029
  br i1 %cmp.not, label %if.end, label %return, !dbg !1030

if.end:                                           ; preds = %entry_after_block_sync_1
  %add10 = add i32 %add9, %add, !dbg !1031
  %mul11 = mul i32 %add10, %Size, !dbg !1032
  %idx.ext = zext i32 %mul11 to i64, !dbg !1033
  %gep = getelementptr float, ptr %invariant.gep, i64 %idx.ext, !dbg !1034
  %5 = load float, ptr %gep, align 4, !dbg !1035, !llvm.mem.parallel_loop_access !1036
  %6 = load float, ptr %add.ptr18, align 4, !dbg !1037, !llvm.mem.parallel_loop_access !1036
  %div = fdiv contract float %5, %6, !dbg !1038
  %gep23 = getelementptr float, ptr %invariant.gep22, i64 %idx.ext, !dbg !1039
  store float %div, ptr %gep23, align 4, !dbg !1040, !llvm.mem.parallel_loop_access !1036
  br label %return, !dbg !1041

return:                                           ; preds = %if.end, %entry_after_block_sync_1
  %intra_warp_index_increment = add nuw i32 %local_intra_warp_idx.021, 1
  %exitcond.not = icmp eq i32 %intra_warp_index_increment, %0
  br i1 %exitcond.not, label %intra_reset_block, label %entry_after_block_sync_1, !llvm.loop !1011

intra_reset_block:                                ; preds = %return, %entry
  ret void, !dbg !1041
}
...
; Function Attrs: convergent mustprogress noinline norecurse nounwind optnone
define dso_local void @_Z4Fan2PfS_S_iii(ptr noalias noundef %m_cuda, ptr noalias noundef %a_cuda, ptr noalias noundef %b_cuda, i32 noundef %Size, i32 %j1, i32 noundef %t) local_unnamed_addr #0 {
entry:
  %0 = load i32, ptr @block_size, align 4
  %.not = icmp eq i32 %0, 0
  br i1 %.not, label %intra_reset_block, label %entry_after_block_sync_1.lr.ph, !llvm.loop !1042
...
entry_after_block_sync_1.lr.ph:                   ; preds = %entry
  ...
  %4 = xor i32 %t, -1
  %sub3 = add i32 %4, %Size
  %5 = tail call ptr @llvm.threadlocal.address.p0(ptr @block_index_y)
  %6 = load i32, ptr @block_size_y, align 4
  %sub9 = sub nsw i32 %Size, %t
  %add23 = add i32 %t, 1
  %mul27 = mul nsw i32 %t, %Size
  %idxprom50 = sext i32 %t to i64
  %arrayidx51 = getelementptr inbounds float, ptr %b_cuda, i64 %idxprom50
  br label %entry_after_block_sync_1

entry_after_block_sync_1:                         ; preds = %if.end58, %entry_after_block_sync_1.lr.ph
  %local_intra_warp_idx.063 = phi i32 [ 0, %entry_after_block_sync_1.lr.ph ], [ %intra_warp_index_increment, %if.end58 ]
  tail call void @llvm.dbg.value(metadata ptr %m_cuda, metadata !1045, metadata !DIExpression()), !dbg !1049
  tail call void @llvm.dbg.value(metadata ptr %a_cuda, metadata !1050, metadata !DIExpression()), !dbg !1049
  tail call void @llvm.dbg.value(metadata ptr %b_cuda, metadata !1051, metadata !DIExpression()), !dbg !1049
  tail call void @llvm.dbg.value(metadata i32 %Size, metadata !1052, metadata !DIExpression()), !dbg !1049
  tail call void @llvm.dbg.value(metadata i32 poison, metadata !1053, metadata !DIExpression()), !dbg !1049
  tail call void @llvm.dbg.value(metadata i32 %t, metadata !1054, metadata !DIExpression()), !dbg !1049
  %local_intra_warp_idx.063.frozen = freeze i32 %local_intra_warp_idx.063
  %.frozen = freeze i32 %1
  %thread_id_y = sdiv i32 %local_intra_warp_idx.063.frozen, %.frozen, !dbg !1055
  %7 = mul i32 %thread_id_y, %.frozen
  %thread_id_x.decomposed = sub i32 %local_intra_warp_idx.063.frozen, %7
  %add = add i32 %mul, %thread_id_x.decomposed, !dbg !1059
  %cmp.not = icmp ult i32 %add, %sub3, !dbg !1061
  br i1 %cmp.not, label %if.end, label %if.end58, !dbg !1062

if.end:                                           ; preds = %entry_after_block_sync_1
  %8 = load i32, ptr %5, align 4, !dbg !1063
  %mul7 = mul i32 %6, %8, !dbg !1066
  %add8 = add i32 %mul7, %thread_id_y, !dbg !1067
  %cmp10.not = icmp ult i32 %add8, %sub9, !dbg !1068
  br i1 %cmp10.not, label %if.end12, label %if.end58, !dbg !1069

if.end12:                                         ; preds = %if.end
  call void @llvm.dbg.declare(metadata ptr undef, metadata !1070, metadata !DIExpression()), !dbg !1071
  call void @llvm.dbg.declare(metadata ptr undef, metadata !1072, metadata !DIExpression()), !dbg !1073
  %add24 = add i32 %add23, %add, !dbg !1074
  %mul25 = mul nsw i32 %add24, %Size, !dbg !1075
  %add26 = add nsw i32 %mul25, %t, !dbg !1076
  %idxprom = sext i32 %add26 to i64, !dbg !1077
  %arrayidx = getelementptr inbounds float, ptr %m_cuda, i64 %idxprom, !dbg !1077
  %9 = load float, ptr %arrayidx, align 4, !dbg !1077
  %add28 = add nsw i32 %add8, %t, !dbg !1078
  %add29 = add nsw i32 %add28, %mul27, !dbg !1079
  %idxprom30 = sext i32 %add29 to i64, !dbg !1080
  %arrayidx31 = getelementptr inbounds float, ptr %a_cuda, i64 %idxprom30, !dbg !1080
  %10 = load float, ptr %arrayidx31, align 4, !dbg !1080, !llvm.mem.parallel_loop_access !1081
  %mul32 = fmul contract float %9, %10, !dbg !1082
  %add37 = add nsw i32 %add28, %mul25, !dbg !1083
  %idxprom38 = sext i32 %add37 to i64, !dbg !1084
  %arrayidx39 = getelementptr inbounds float, ptr %a_cuda, i64 %idxprom38, !dbg !1084
  %11 = load float, ptr %arrayidx39, align 4, !dbg !1085, !llvm.mem.parallel_loop_access !1081
  %sub40 = fsub contract float %11, %mul32, !dbg !1085
  store float %sub40, ptr %arrayidx39, align 4, !dbg !1085, !llvm.mem.parallel_loop_access !1081
  %cmp41 = icmp eq i32 %add8, 0, !dbg !1086
  br i1 %cmp41, label %if.then42, label %if.end58, !dbg !1088

if.then42:                                        ; preds = %if.end12
  %12 = load float, ptr %arrayidx51, align 4, !dbg !1089, !llvm.mem.parallel_loop_access !1081
  %mul52 = fmul contract float %9, %12, !dbg !1091
  %idxprom55 = sext i32 %add24 to i64, !dbg !1092
  %arrayidx56 = getelementptr inbounds float, ptr %b_cuda, i64 %idxprom55, !dbg !1092
  %13 = load float, ptr %arrayidx56, align 4, !dbg !1093, !llvm.mem.parallel_loop_access !1081
  %sub57 = fsub contract float %13, %mul52, !dbg !1093
  store float %sub57, ptr %arrayidx56, align 4, !dbg !1093, !llvm.mem.parallel_loop_access !1081
  br label %if.end58, !dbg !1094

if.end58:                                         ; preds = %if.then42, %if.end12, %if.end, %entry_after_block_sync_1
  %intra_warp_index_increment = add nuw i32 %local_intra_warp_idx.063, 1
  %exitcond.not = icmp eq i32 %intra_warp_index_increment, %0
  br i1 %exitcond.not, label %intra_reset_block, label %entry_after_block_sync_1, !llvm.loop !1042

intra_reset_block:                                ; preds = %if.end58, %entry
  ret void, !dbg !1095
}
...
define void @Fan1PfS_ii_wrapper(ptr noalias nocapture readonly %0) local_unnamed_addr #2 {
  ...
  tail call void @_Z4Fan1PfS_ii(ptr %2, ptr %4, i32 %6, i32 %8)
  ret void
}

; Function Attrs: norecurse nounwind
define void @Fan2PfS_S_iii_wrapper(ptr noalias nocapture readonly %0) local_unnamed_addr #2 {
  %2 = load ptr, ptr %0, align 8
  %3 = getelementptr ptr, ptr %0, i64 1
  %4 = load ptr, ptr %3, align 8
  %5 = getelementptr ptr, ptr %0, i64 2
  ...
  %7 = getelementptr ptr, ptr %0, i64 3
  %8 = load i32, ptr %7, align 4
  %9 = getelementptr ptr, ptr %0, i64 5
  %10 = load i32, ptr %9, align 4
  tail call void @_Z4Fan2PfS_S_iii(ptr %2, ptr %4, ptr %6, i32 %8, i32 poison, i32 %10)
  ret void
}
...
!1013 = distinct !{}
!1014 = !DILocalVariable(name: "m_cuda", arg: 1, scope: !1015, file: !1016, line: 318, type: !296)
!1015 = distinct !DISubprogram(name: "Fan1", linkageName: "_Z4Fan1PfS_ii", scope: !1016, file: !1016, line: 318, type: !1017, scopeLine: 319, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, retainedNodes: !1019)
!1016 = !DIFile(filename: "./gaussian.cu", directory: "/nethome/cahn45/CuPBoP/examples/gauss")
!1017 = !DISubroutineType(types: !1018)
!1018 = !{null, !296, !296, !160, !160}
!1019 = !{}
!1020 = !DILocation(line: 0, scope: !1015)
!1021 = !DILocalVariable(name: "a_cuda", arg: 2, scope: !1015, file: !1016, line: 318, type: !296)
!1022 = !DILocalVariable(name: "Size", arg: 3, scope: !1015, file: !1016, line: 318, type: !160)
!1023 = !DILocalVariable(name: "t", arg: 4, scope: !1015, file: !1016, line: 318, type: !160)
...
!1027 = distinct !DILexicalBlock(scope: !1015, file: !1016, line: 323, column: 5)
!1028 = !DILocation(line: 323, column: 17, scope: !1027)
!1029 = !DILocation(line: 323, column: 43, scope: !1027)
!1030 = !DILocation(line: 323, column: 5, scope: !1015)
!1031 = !DILocation(line: 324, column: 111, scope: !1015)
!1032 = !DILocation(line: 324, column: 74, scope: !1015)
!1033 = !DILocation(line: 324, column: 69, scope: !1015)
!1034 = !DILocation(line: 324, column: 114, scope: !1015)
!1035 = !DILocation(line: 324, column: 61, scope: !1015)
!1036 = !{!1013}
!1037 = !DILocation(line: 324, column: 120, scope: !1015)
!1038 = !DILocation(line: 324, column: 118, scope: !1015)
!1039 = !DILocation(line: 324, column: 55, scope: !1015)
!1040 = !DILocation(line: 324, column: 59, scope: !1015)
!1041 = !DILocation(line: 325, column: 1, scope: !1015)
!1042 = distinct !{!1042, !1043}
!1043 = !{!"llvm.loop.parallel_accesses", !1044}
!1044 = distinct !{}
!1045 = !DILocalVariable(name: "m_cuda", arg: 1, scope: !1046, file: !1016, line: 332, type: !296)
!1046 = distinct !DISubprogram(name: "Fan2", linkageName: "_Z4Fan2PfS_S_iii", scope: !1016, file: !1016, line: 332, type: !1047, scopeLine: 333, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, retainedNodes: !1019)
!1047 = !DISubroutineType(types: !1048)
!1048 = !{null, !296, !296, !296, !160, !160, !160}
!1049 = !DILocation(line: 0, scope: !1046)
!1050 = !DILocalVariable(name: "a_cuda", arg: 2, scope: !1046, file: !1016, line: 332, type: !296)
!1051 = !DILocalVariable(name: "b_cuda", arg: 3, scope: !1046, file: !1016, line: 332, type: !296)
!1052 = !DILocalVariable(name: "Size", arg: 4, scope: !1046, file: !1016, line: 332, type: !160)
!1053 = !DILocalVariable(name: "j1", arg: 5, scope: !1046, file: !1016, line: 332, type: !160)
!1054 = !DILocalVariable(name: "t", arg: 6, scope: !1046, file: !1016, line: 332, type: !160)
!1055 = !DILocation(line: 54, column: 180, scope: !1056, inlinedAt: !1057)
!1056 = distinct !DISubprogram(name: "__fetch_builtin_y", linkageName: "_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_yEv", scope: !66, file: !67, line: 54, type: !70, scopeLine: 54, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, declaration: !72)
!1057 = distinct !DILocation(line: 335, column: 5, scope: !1058)
!1058 = distinct !DILexicalBlock(scope: !1046, file: !1016, line: 335, column: 5)
!1059 = !DILocation(line: 334, column: 17, scope: !1060)
!1060 = distinct !DILexicalBlock(scope: !1046, file: !1016, line: 334, column: 5)
!1061 = !DILocation(line: 334, column: 43, scope: !1060)
!1062 = !DILocation(line: 334, column: 5, scope: !1046)
!1063 = !DILocation(line: 67, column: 180, scope: !1064, inlinedAt: !1065)
!1064 = distinct !DISubprogram(name: "__fetch_builtin_y", linkageName: "_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_yEv", scope: !97, file: !67, line: 67, type: !70, scopeLine: 67, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, declaration: !100)
!1065 = distinct !DILocation(line: 335, column: 19, scope: !1058)
!1066 = !DILocation(line: 335, column: 30, scope: !1058)
!1067 = !DILocation(line: 335, column: 17, scope: !1058)
!1068 = !DILocation(line: 335, column: 43, scope: !1058)
!1069 = !DILocation(line: 335, column: 5, scope: !1046)
!1070 = !DILocalVariable(name: "xidx", scope: !1046, file: !1016, line: 337, type: !160)
!1071 = !DILocation(line: 337, column: 6, scope: !1046)
!1072 = !DILocalVariable(name: "yidx", scope: !1046, file: !1016, line: 338, type: !160)
!1073 = !DILocation(line: 338, column: 6, scope: !1046)
!1074 = !DILocation(line: 341, column: 57, scope: !1046)
!1075 = !DILocation(line: 341, column: 49, scope: !1046)
!1076 = !DILocation(line: 341, column: 60, scope: !1046)
!1077 = !DILocation(line: 341, column: 38, scope: !1046)
!1078 = !DILocation(line: 341, column: 85, scope: !1046)
!1079 = !DILocation(line: 341, column: 79, scope: !1046)
!1080 = !DILocation(line: 341, column: 66, scope: !1046)
!1081 = !{!1044}
!1082 = !DILocation(line: 341, column: 64, scope: !1046)
!1083 = !DILocation(line: 341, column: 24, scope: !1046)
!1084 = !DILocation(line: 341, column: 2, scope: !1046)
!1085 = !DILocation(line: 341, column: 35, scope: !1046)
!1086 = !DILocation(line: 343, column: 10, scope: !1087)
!1087 = distinct !DILexicalBlock(scope: !1046, file: !1016, line: 343, column: 5)
!1088 = !DILocation(line: 343, column: 5, scope: !1046)
!1089 = !DILocation(line: 346, column: 58, scope: !1090)
!1090 = distinct !DILexicalBlock(scope: !1087, file: !1016, line: 343, column: 15)
!1091 = !DILocation(line: 346, column: 56, scope: !1090)
!1092 = !DILocation(line: 346, column: 3, scope: !1090)
!1093 = !DILocation(line: 346, column: 20, scope: !1090)
!1094 = !DILocation(line: 347, column: 2, scope: !1090)
!1095 = !DILocation(line: 348, column: 1, scope: !1046)
