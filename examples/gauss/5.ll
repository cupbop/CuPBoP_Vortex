...
entry_after_block_sync_1:                         ; preds = %intra_warp_cond
  ...
  %4 = call noundef i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !dbg !1028
  %5 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !dbg !1032
  %6 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ntid.x(), !dbg !1035
  %mul = mul i32 %5, %6, !dbg !1038
  %add = add i32 %4, %mul, !dbg !1039
  %7 = load i32, ptr %Size.addr, align 4, !dbg !1040, !llvm.mem.parallel_loop_access !1014
  %sub = sub nsw i32 %7, 1, !dbg !1041
  %8 = load i32, ptr %t.addr, align 4, !dbg !1042, !llvm.mem.parallel_loop_access !1014
  %sub3 = sub nsw i32 %sub, %8, !dbg !1043
...
if.end:                                           ; preds = %entry_after_block_sync_1
  %9 = load ptr, ptr %a_cuda.addr, align 8, !dbg !1047, !llvm.mem.parallel_loop_access !1014
  %10 = load i32, ptr %Size.addr, align 4, !dbg !1048, !llvm.mem.parallel_loop_access !1014
  %11 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ntid.x(), !dbg !1049
  %12 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !dbg !1051
  %mul6 = mul i32 %11, %12, !dbg !1053
  %13 = call noundef i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !dbg !1054
  %add8 = add i32 %mul6, %13, !dbg !1056
  %14 = load i32, ptr %t.addr, align 4, !dbg !1057, !llvm.mem.parallel_loop_access !1014
  %add9 = add i32 %add8, %14, !dbg !1058
  %add10 = add i32 %add9, 1, !dbg !1059
  %mul11 = mul i32 %10, %add10, !dbg !1060
  %idx.ext = zext i32 %mul11 to i64, !dbg !1061
  %add.ptr = getelementptr inbounds float, ptr %9, i64 %idx.ext, !dbg !1061
  %15 = load i32, ptr %t.addr, align 4, !dbg !1062, !llvm.mem.parallel_loop_access !1014
  %idx.ext12 = sext i32 %15 to i64, !dbg !1063
  %add.ptr13 = getelementptr inbounds float, ptr %add.ptr, i64 %idx.ext12, !dbg !1063
  %16 = load float, ptr %add.ptr13, align 4, !dbg !1064, !llvm.mem.parallel_loop_access !1014
  %17 = load ptr, ptr %a_cuda.addr, align 8, !dbg !1065, !llvm.mem.parallel_loop_access !1014
  %18 = load i32, ptr %Size.addr, align 4, !dbg !1066, !llvm.mem.parallel_loop_access !1014
  %19 = load i32, ptr %t.addr, align 4, !dbg !1067, !llvm.mem.parallel_loop_access !1014
  %mul14 = mul nsw i32 %18, %19, !dbg !1068
  %idx.ext15 = sext i32 %mul14 to i64, !dbg !1069
  %add.ptr16 = getelementptr inbounds float, ptr %17, i64 %idx.ext15, !dbg !1069
  %20 = load i32, ptr %t.addr, align 4, !dbg !1070, !llvm.mem.parallel_loop_access !1014
  %idx.ext17 = sext i32 %20 to i64, !dbg !1071
  %add.ptr18 = getelementptr inbounds float, ptr %add.ptr16, i64 %idx.ext17, !dbg !1071
  %21 = load float, ptr %add.ptr18, align 4, !dbg !1072, !llvm.mem.parallel_loop_access !1014
  %div = fdiv contract float %16, %21, !dbg !1073
  %22 = load ptr, ptr %m_cuda.addr, align 8, !dbg !1074, !llvm.mem.parallel_loop_access !1014
  %23 = load i32, ptr %Size.addr, align 4, !dbg !1075, !llvm.mem.parallel_loop_access !1014
  %24 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ntid.x(), !dbg !1076
  %25 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !dbg !1078
  %mul21 = mul i32 %24, %25, !dbg !1080
  %26 = call noundef i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !dbg !1081
  %add23 = add i32 %mul21, %26, !dbg !1083
  %27 = load i32, ptr %t.addr, align 4, !dbg !1084, !llvm.mem.parallel_loop_access !1014
  %add24 = add i32 %add23, %27, !dbg !1085
  %add25 = add i32 %add24, 1, !dbg !1086
  %mul26 = mul i32 %23, %add25, !dbg !1087
  %idx.ext27 = zext i32 %mul26 to i64, !dbg !1088
  %add.ptr28 = getelementptr inbounds float, ptr %22, i64 %idx.ext27, !dbg !1088
  %28 = load i32, ptr %t.addr, align 4, !dbg !1089, !llvm.mem.parallel_loop_access !1014
  %idx.ext29 = sext i32 %28 to i64, !dbg !1090
...
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !dbg !1093
  ret i32 %0, !dbg !1094
}
...
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !dbg !1095
  ret i32 %0, !dbg !1096
}
...
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ntid.x(), !dbg !1097
  ret i32 %0, !dbg !1098
}
...
intra_warp_inc:                                   ; preds = %if.end58
  %3 = load i32, ptr @intra_warp_index, align 4
  %intra_warp_index_increment = add i32 %3, 1
  store i32 %intra_warp_index_increment, ptr @intra_warp_index, align 4
  br label %intra_warp_cond

intra_warp_cond:                                  ; preds = %intra_warp_inc, %intra_warp_init
  %4 = load i32, ptr @intra_warp_index, align 4
  %5 = icmp ult i32 %4, %2
...
entry_after_block_sync_1:                         ; preds = %intra_warp_cond
  ...
  %6 = call noundef i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !dbg !1118
  %7 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !dbg !1121
  %8 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ntid.x(), !dbg !1123
  %mul = mul i32 %7, %8, !dbg !1125
  %add = add i32 %6, %mul, !dbg !1126
  %9 = load i32, ptr %Size.addr, align 4, !dbg !1127, !llvm.mem.parallel_loop_access !1102
  %sub = sub nsw i32 %9, 1, !dbg !1128
  %10 = load i32, ptr %t.addr, align 4, !dbg !1129, !llvm.mem.parallel_loop_access !1102
  %sub3 = sub nsw i32 %sub, %10, !dbg !1130
...
if.end:                                           ; preds = %entry_after_block_sync_1
  %11 = call noundef i32 @llvm.nvvm.read.ptx.sreg.tid.y(), !dbg !1134
  %12 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ctaid.y(), !dbg !1138
  %13 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ntid.y(), !dbg !1141
  %mul7 = mul i32 %12, %13, !dbg !1144
  %add8 = add i32 %11, %mul7, !dbg !1145
  %14 = load i32, ptr %Size.addr, align 4, !dbg !1146, !llvm.mem.parallel_loop_access !1102
  %15 = load i32, ptr %t.addr, align 4, !dbg !1147, !llvm.mem.parallel_loop_access !1102
  %sub9 = sub nsw i32 %14, %15, !dbg !1148
...
if.end12:                                         ; preds = %if.end
  ...
  %16 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !dbg !1154
  %17 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ntid.x(), !dbg !1156
  %mul15 = mul i32 %16, %17, !dbg !1158
  %18 = call noundef i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !dbg !1159
  %add17 = add i32 %mul15, %18, !dbg !1161
  %19 = load i32, ptr @inter_warp_index, align 4, !dbg !1153, !llvm.mem.parallel_loop_access !1102
  %20 = load i32, ptr @intra_warp_index, align 4, !dbg !1153, !llvm.mem.parallel_loop_access !1102
  %21 = mul i32 %19, 32, !dbg !1153
  %thread_idx4 = add i32 %20, %21, !dbg !1153
  %22 = getelementptr i32, ptr %xidx_intra_warp_, i32 %thread_idx4, !dbg !1153
  store i32 %add17, ptr %22, align 4, !dbg !1153, !llvm.mem.parallel_loop_access !1102
  call void @llvm.dbg.declare(metadata ptr %yidx, metadata !1162, metadata !DIExpression()), !dbg !1163
  %23 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ctaid.y(), !dbg !1164
  %24 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ntid.y(), !dbg !1166
  %mul20 = mul i32 %23, %24, !dbg !1168
  %25 = call noundef i32 @llvm.nvvm.read.ptx.sreg.tid.y(), !dbg !1169
  %add22 = add i32 %mul20, %25, !dbg !1171
  %26 = load i32, ptr @inter_warp_index, align 4, !dbg !1163, !llvm.mem.parallel_loop_access !1102
  %27 = load i32, ptr @intra_warp_index, align 4, !dbg !1163, !llvm.mem.parallel_loop_access !1102
  %28 = mul i32 %26, 32, !dbg !1163
  %thread_idx9 = add i32 %27, %28, !dbg !1163
  %29 = getelementptr i32, ptr %yidx_intra_warp_, i32 %thread_idx9, !dbg !1163
  store i32 %add22, ptr %29, align 4, !dbg !1163, !llvm.mem.parallel_loop_access !1102
  %30 = load ptr, ptr %m_cuda.addr, align 8, !dbg !1172, !llvm.mem.parallel_loop_access !1102
  %31 = load i32, ptr %Size.addr, align 4, !dbg !1173, !llvm.mem.parallel_loop_access !1102
  %32 = load i32, ptr @inter_warp_index, align 4, !dbg !1174, !llvm.mem.parallel_loop_access !1102
  %33 = load i32, ptr @intra_warp_index, align 4, !dbg !1174, !llvm.mem.parallel_loop_access !1102
  %34 = mul i32 %32, 32, !dbg !1174
  %thread_idx3 = add i32 %33, %34, !dbg !1174
  %35 = getelementptr i32, ptr %xidx_intra_warp_, i32 %thread_idx3, !dbg !1174
  %36 = load i32, ptr %35, align 4, !dbg !1174, !llvm.mem.parallel_loop_access !1102
  %add23 = add nsw i32 %36, 1, !dbg !1175
  %37 = load i32, ptr %t.addr, align 4, !dbg !1176, !llvm.mem.parallel_loop_access !1102
  %add24 = add nsw i32 %add23, %37, !dbg !1177
  %mul25 = mul nsw i32 %31, %add24, !dbg !1178
  %38 = load i32, ptr %t.addr, align 4, !dbg !1179, !llvm.mem.parallel_loop_access !1102
  %add26 = add nsw i32 %mul25, %38, !dbg !1180
  %idxprom = sext i32 %add26 to i64, !dbg !1172
  %arrayidx = getelementptr inbounds float, ptr %30, i64 %idxprom, !dbg !1172
  %39 = load float, ptr %arrayidx, align 4, !dbg !1172, !llvm.mem.parallel_loop_access !1102
  %40 = load ptr, ptr %a_cuda.addr, align 8, !dbg !1181, !llvm.mem.parallel_loop_access !1102
  %41 = load i32, ptr %Size.addr, align 4, !dbg !1182, !llvm.mem.parallel_loop_access !1102
  %42 = load i32, ptr %t.addr, align 4, !dbg !1183, !llvm.mem.parallel_loop_access !1102
  %mul27 = mul nsw i32 %41, %42, !dbg !1184
  %43 = load i32, ptr @inter_warp_index, align 4, !dbg !1185, !llvm.mem.parallel_loop_access !1102
  %44 = load i32, ptr @intra_warp_index, align 4, !dbg !1185, !llvm.mem.parallel_loop_access !1102
  %45 = mul i32 %43, 32, !dbg !1185
  %thread_idx8 = add i32 %44, %45, !dbg !1185
  %46 = getelementptr i32, ptr %yidx_intra_warp_, i32 %thread_idx8, !dbg !1185
  %47 = load i32, ptr %46, align 4, !dbg !1185, !llvm.mem.parallel_loop_access !1102
  %48 = load i32, ptr %t.addr, align 4, !dbg !1186, !llvm.mem.parallel_loop_access !1102
  %add28 = add nsw i32 %47, %48, !dbg !1187
  %add29 = add nsw i32 %mul27, %add28, !dbg !1188
  %idxprom30 = sext i32 %add29 to i64, !dbg !1181
  %arrayidx31 = getelementptr inbounds float, ptr %40, i64 %idxprom30, !dbg !1181
  %49 = load float, ptr %arrayidx31, align 4, !dbg !1181, !llvm.mem.parallel_loop_access !1102
  %mul32 = fmul contract float %39, %49, !dbg !1189
  %50 = load ptr, ptr %a_cuda.addr, align 8, !dbg !1190, !llvm.mem.parallel_loop_access !1102
  %51 = load i32, ptr %Size.addr, align 4, !dbg !1191, !llvm.mem.parallel_loop_access !1102
  %52 = load i32, ptr @inter_warp_index, align 4, !dbg !1192, !llvm.mem.parallel_loop_access !1102
  %53 = load i32, ptr @intra_warp_index, align 4, !dbg !1192, !llvm.mem.parallel_loop_access !1102
  %54 = mul i32 %52, 32, !dbg !1192
  %thread_idx2 = add i32 %53, %54, !dbg !1192
  %55 = getelementptr i32, ptr %xidx_intra_warp_, i32 %thread_idx2, !dbg !1192
  %56 = load i32, ptr %55, align 4, !dbg !1192, !llvm.mem.parallel_loop_access !1102
  %add33 = add nsw i32 %56, 1, !dbg !1193
  %57 = load i32, ptr %t.addr, align 4, !dbg !1194, !llvm.mem.parallel_loop_access !1102
  %add34 = add nsw i32 %add33, %57, !dbg !1195
  %mul35 = mul nsw i32 %51, %add34, !dbg !1196
  %58 = load i32, ptr @inter_warp_index, align 4, !dbg !1197, !llvm.mem.parallel_loop_access !1102
  %59 = load i32, ptr @intra_warp_index, align 4, !dbg !1197, !llvm.mem.parallel_loop_access !1102
  %60 = mul i32 %58, 32, !dbg !1197
  %thread_idx7 = add i32 %59, %60, !dbg !1197
  %61 = getelementptr i32, ptr %yidx_intra_warp_, i32 %thread_idx7, !dbg !1197
  %62 = load i32, ptr %61, align 4, !dbg !1197, !llvm.mem.parallel_loop_access !1102
  %63 = load i32, ptr %t.addr, align 4, !dbg !1198, !llvm.mem.parallel_loop_access !1102
  %add36 = add nsw i32 %62, %63, !dbg !1199
  %add37 = add nsw i32 %mul35, %add36, !dbg !1200
  %idxprom38 = sext i32 %add37 to i64, !dbg !1190
  %arrayidx39 = getelementptr inbounds float, ptr %50, i64 %idxprom38, !dbg !1190
  %64 = load float, ptr %arrayidx39, align 4, !dbg !1201, !llvm.mem.parallel_loop_access !1102
  %sub40 = fsub contract float %64, %mul32, !dbg !1201
  store float %sub40, ptr %arrayidx39, align 4, !dbg !1201, !llvm.mem.parallel_loop_access !1102
  %65 = load i32, ptr @inter_warp_index, align 4, !dbg !1202, !llvm.mem.parallel_loop_access !1102
  %66 = load i32, ptr @intra_warp_index, align 4, !dbg !1202, !llvm.mem.parallel_loop_access !1102
  %67 = mul i32 %65, 32, !dbg !1202
  %thread_idx6 = add i32 %66, %67, !dbg !1202
  %68 = getelementptr i32, ptr %yidx_intra_warp_, i32 %thread_idx6, !dbg !1202
  %69 = load i32, ptr %68, align 4, !dbg !1202, !llvm.mem.parallel_loop_access !1102, !divergence !1204
  %cmp41 = icmp eq i32 %69, 0, !dbg !1205
  br i1 %cmp41, label %if.then42, label %if.end58, !dbg !1206

if.then42:                                        ; preds = %if.end12
  %70 = load ptr, ptr %m_cuda.addr, align 8, !dbg !1207, !llvm.mem.parallel_loop_access !1102
  %71 = load i32, ptr %Size.addr, align 4, !dbg !1209, !llvm.mem.parallel_loop_access !1102
  %72 = load i32, ptr @inter_warp_index, align 4, !dbg !1210, !llvm.mem.parallel_loop_access !1102
  %73 = load i32, ptr @intra_warp_index, align 4, !dbg !1210, !llvm.mem.parallel_loop_access !1102
  %74 = mul i32 %72, 32, !dbg !1210
  %thread_idx1 = add i32 %73, %74, !dbg !1210
  %75 = getelementptr i32, ptr %xidx_intra_warp_, i32 %thread_idx1, !dbg !1210
  %76 = load i32, ptr %75, align 4, !dbg !1210, !llvm.mem.parallel_loop_access !1102
  %add43 = add nsw i32 %76, 1, !dbg !1211
  %77 = load i32, ptr %t.addr, align 4, !dbg !1212, !llvm.mem.parallel_loop_access !1102
  %add44 = add nsw i32 %add43, %77, !dbg !1213
  %mul45 = mul nsw i32 %71, %add44, !dbg !1214
  %78 = load i32, ptr @inter_warp_index, align 4, !dbg !1215, !llvm.mem.parallel_loop_access !1102
  %79 = load i32, ptr @intra_warp_index, align 4, !dbg !1215, !llvm.mem.parallel_loop_access !1102
  %80 = mul i32 %78, 32, !dbg !1215
  %thread_idx5 = add i32 %79, %80, !dbg !1215
  %81 = getelementptr i32, ptr %yidx_intra_warp_, i32 %thread_idx5, !dbg !1215
  %82 = load i32, ptr %81, align 4, !dbg !1215, !llvm.mem.parallel_loop_access !1102
  %83 = load i32, ptr %t.addr, align 4, !dbg !1216, !llvm.mem.parallel_loop_access !1102
  %add46 = add nsw i32 %82, %83, !dbg !1217
  %add47 = add nsw i32 %mul45, %add46, !dbg !1218
  %idxprom48 = sext i32 %add47 to i64, !dbg !1207
  %arrayidx49 = getelementptr inbounds float, ptr %70, i64 %idxprom48, !dbg !1207
  %84 = load float, ptr %arrayidx49, align 4, !dbg !1207, !llvm.mem.parallel_loop_access !1102
  %85 = load ptr, ptr %b_cuda.addr, align 8, !dbg !1219, !llvm.mem.parallel_loop_access !1102
  %86 = load i32, ptr %t.addr, align 4, !dbg !1220, !llvm.mem.parallel_loop_access !1102
  %idxprom50 = sext i32 %86 to i64, !dbg !1219
  %arrayidx51 = getelementptr inbounds float, ptr %85, i64 %idxprom50, !dbg !1219
  %87 = load float, ptr %arrayidx51, align 4, !dbg !1219, !llvm.mem.parallel_loop_access !1102
  %mul52 = fmul contract float %84, %87, !dbg !1221
  %88 = load ptr, ptr %b_cuda.addr, align 8, !dbg !1222, !llvm.mem.parallel_loop_access !1102
  %89 = load i32, ptr @inter_warp_index, align 4, !dbg !1223, !llvm.mem.parallel_loop_access !1102
  %90 = load i32, ptr @intra_warp_index, align 4, !dbg !1223, !llvm.mem.parallel_loop_access !1102
  %91 = mul i32 %89, 32, !dbg !1223
  %thread_idx = add i32 %90, %91, !dbg !1223
  %92 = getelementptr i32, ptr %xidx_intra_warp_, i32 %thread_idx, !dbg !1223
  %93 = load i32, ptr %92, align 4, !dbg !1223, !llvm.mem.parallel_loop_access !1102
  %add53 = add nsw i32 %93, 1, !dbg !1224
  %94 = load i32, ptr %t.addr, align 4, !dbg !1225, !llvm.mem.parallel_loop_access !1102
  %add54 = add nsw i32 %add53, %94, !dbg !1226
  %idxprom55 = sext i32 %add54 to i64, !dbg !1222
  %arrayidx56 = getelementptr inbounds float, ptr %88, i64 %idxprom55, !dbg !1222
  %95 = load float, ptr %arrayidx56, align 4, !dbg !1227, !llvm.mem.parallel_loop_access !1102
  %sub57 = fsub contract float %95, %mul52, !dbg !1227
...
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.tid.y(), !dbg !1230
  ret i32 %0, !dbg !1231
}
...
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.y(), !dbg !1232
  ret i32 %0, !dbg !1233
}
...
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ntid.y(), !dbg !1234
  ret i32 %0, !dbg !1235
}
