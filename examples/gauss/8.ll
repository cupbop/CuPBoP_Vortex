...
entry_after_block_sync_1:                         ; preds = %entry_after_block_sync_1.lr.ph, %return
...
return:                                           ; preds = %entry_after_block_sync_1, %if.end
...
entry_after_block_sync_1:                         ; preds = %entry_after_block_sync_1.lr.ph, %if.end58
...
if.end58:                                         ; preds = %if.end, %entry_after_block_sync_1, %if.then42, %if.end12
