...
define dso_local void @_Z21spmv_jds_naive_kernelPfPKfPKiS3_S1_iS3_S3_i(ptr noalias noundef %d_Ax, ptr noalias noundef %d_data, ptr noalias noundef %d_idx, ptr noalias noundef %d_perm, ptr noalias noundef %d_x, i32 noundef %dim, ptr noalias noundef %jds_ptr, ptr noalias noundef %sh_zcnt, i32 noundef %pad) local_unnamed_addr #0 {
entry:
  %0 = load i32, ptr @__local_group_id, align 4
  %1 = load i32, ptr @__warps_per_group, align 4
  tail call void @vx_barrier(i32 %0, i32 %1) #4, !divergence !1759
  tail call void @llvm.dbg.value(metadata ptr %d_Ax, metadata !1760, metadata !DIExpression()), !dbg !1773
  tail call void @llvm.dbg.value(metadata ptr %d_data, metadata !1774, metadata !DIExpression()), !dbg !1773
  tail call void @llvm.dbg.value(metadata ptr %d_idx, metadata !1775, metadata !DIExpression()), !dbg !1773
  tail call void @llvm.dbg.value(metadata ptr %d_perm, metadata !1776, metadata !DIExpression()), !dbg !1773
  tail call void @llvm.dbg.value(metadata ptr %d_x, metadata !1777, metadata !DIExpression()), !dbg !1773
  tail call void @llvm.dbg.value(metadata i32 %dim, metadata !1778, metadata !DIExpression()), !dbg !1773
  tail call void @llvm.dbg.value(metadata ptr %jds_ptr, metadata !1779, metadata !DIExpression()), !dbg !1773
  tail call void @llvm.dbg.value(metadata ptr %sh_zcnt, metadata !1780, metadata !DIExpression()), !dbg !1773
  tail call void @llvm.dbg.value(metadata i32 %pad, metadata !1781, metadata !DIExpression()), !dbg !1773
  %2 = tail call ptr @llvm.threadlocal.address.p0(ptr @block_index_x), !dbg !1782
  %3 = load i32, ptr %2, align 4, !dbg !1782
  %4 = load i32, ptr @block_size_x, align 4, !dbg !1785
  %mul = mul i32 %4, %3, !dbg !1788
  %5 = tail call ptr @llvm.threadlocal.address.p0(ptr @thread_id_x), !dbg !1789
  %tidx = load i32, ptr %5, align 4, !dbg !1789, !divergence !1759
  %add = add i32 %mul, %tidx, !dbg !1792
  tail call void @llvm.dbg.value(metadata i32 %add, metadata !1793, metadata !DIExpression()), !dbg !1773
  %cmp.not = icmp slt i32 %add, %dim, !dbg !1794
  br i1 %cmp.not, label %if.end, label %return, !dbg !1796

if.end:                                           ; preds = %entry
  %div = sdiv i32 %add, %pad, !dbg !1797
  tail call void @llvm.dbg.value(metadata i32 %div, metadata !1798, metadata !DIExpression()), !dbg !1773
  tail call void @llvm.dbg.value(metadata float 0.000000e+00, metadata !1799, metadata !DIExpression()), !dbg !1773
  %idxprom = sext i32 %div to i64, !dbg !1800
  %arrayidx = getelementptr inbounds i32, ptr %sh_zcnt, i64 %idxprom, !dbg !1800
  %6 = load i32, ptr %arrayidx, align 4, !dbg !1800
  tail call void @llvm.dbg.value(metadata i32 %6, metadata !1801, metadata !DIExpression()), !dbg !1773
  tail call void @llvm.dbg.value(metadata i32 0, metadata !1802, metadata !DIExpression()), !dbg !1804
  tail call void @llvm.dbg.value(metadata float 0.000000e+00, metadata !1799, metadata !DIExpression()), !dbg !1773
  %cmp38 = icmp sgt i32 %6, 0, !dbg !1805
  br i1 %cmp38, label %for.body.preheader, label %for.end, !dbg !1807

for.body.preheader:                               ; preds = %if.end
  %wide.trip.count = zext nneg i32 %6 to i64, !dbg !1805
  br label %for.body, !dbg !1807

for.body:                                         ; preds = %for.body.preheader, %for.body
  %indvars.iv = phi i64 [ 0, %for.body.preheader ], [ %indvars.iv.next, %for.body ]
  %sum.010 = phi float [ 0.000000e+00, %for.body.preheader ], [ %add14, %for.body ]
  tail call void @llvm.dbg.value(metadata float %sum.010, metadata !1799, metadata !DIExpression()), !dbg !1773
  tail call void @llvm.dbg.value(metadata i64 %indvars.iv, metadata !1802, metadata !DIExpression()), !dbg !1804
  %arrayidx5 = getelementptr inbounds i32, ptr %jds_ptr, i64 %indvars.iv, !dbg !1808
  %7 = load i32, ptr %arrayidx5, align 4, !dbg !1808
  %add6 = add nsw i32 %7, %add, !dbg !1810
  tail call void @llvm.dbg.value(metadata i32 %add6, metadata !1811, metadata !DIExpression()), !dbg !1812
  %idxprom7 = sext i32 %add6 to i64, !dbg !1813
  %arrayidx8 = getelementptr inbounds float, ptr %d_data, i64 %idxprom7, !dbg !1813
  %8 = load float, ptr %arrayidx8, align 4, !dbg !1813
  %arrayidx10 = getelementptr inbounds i32, ptr %d_idx, i64 %idxprom7, !dbg !1814
  %9 = load i32, ptr %arrayidx10, align 4, !dbg !1814
  %idxprom11 = sext i32 %9 to i64, !dbg !1815
  %arrayidx12 = getelementptr inbounds float, ptr %d_x, i64 %idxprom11, !dbg !1815
  %10 = load float, ptr %arrayidx12, align 4, !dbg !1815
  %mul13 = fmul contract float %8, %10, !dbg !1816
  %add14 = fadd contract float %sum.010, %mul13, !dbg !1817
  tail call void @llvm.dbg.value(metadata float %add14, metadata !1799, metadata !DIExpression()), !dbg !1773
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !1818
  tail call void @llvm.dbg.value(metadata i64 %indvars.iv.next, metadata !1802, metadata !DIExpression()), !dbg !1804
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count, !dbg !1805
  br i1 %exitcond.not, label %for.end, label %for.body, !dbg !1807, !llvm.loop !1819

for.end:                                          ; preds = %for.body, %if.end
  %sum.0.lcssa = phi float [ 0.000000e+00, %if.end ], [ %add14, %for.body ], !dbg !1773
  %idxprom15 = sext i32 %add to i64, !dbg !1823
  %arrayidx16 = getelementptr inbounds i32, ptr %d_perm, i64 %idxprom15, !dbg !1823
  %11 = load i32, ptr %arrayidx16, align 4, !dbg !1823
  %idxprom17 = sext i32 %11 to i64, !dbg !1824
  %arrayidx18 = getelementptr inbounds float, ptr %d_Ax, i64 %idxprom17, !dbg !1824
  store float %sum.0.lcssa, ptr %arrayidx18, align 4, !dbg !1825
  br label %return, !dbg !1826

return:                                           ; preds = %entry, %for.end
  %12 = load i32, ptr @__local_group_id, align 4
  %13 = load i32, ptr @__warps_per_group, align 4
  tail call void @vx_barrier(i32 %12, i32 %13) #4, !divergence !1759
  ret void, !dbg !1826
}
...
define void @spmv_jds_naive_kernelPfPKfPKiS3_S1_iS3_S3_i_wrapper(ptr noalias nocapture readonly %0) local_unnamed_addr #2 {
  ...
  tail call void @_Z21spmv_jds_naive_kernelPfPKfPKiS3_S1_iS3_S3_i(ptr %2, ptr %4, ptr %6, ptr %8, ptr %10, i32 %12, ptr %14, ptr %16, i32 %18)
  ret void
}
...
!1775 = !DILocalVariable(name: "d_idx", arg: 3, scope: !1761, file: !1762, line: 399, type: !1769)
!1776 = !DILocalVariable(name: "d_perm", arg: 4, scope: !1761, file: !1762, line: 400, type: !1769)
!1777 = !DILocalVariable(name: "d_x", arg: 5, scope: !1761, file: !1762, line: 401, type: !1766)
!1778 = !DILocalVariable(name: "dim", arg: 6, scope: !1761, file: !1762, line: 402, type: !160)
!1779 = !DILocalVariable(name: "jds_ptr", arg: 7, scope: !1761, file: !1762, line: 403, type: !1769)
!1780 = !DILocalVariable(name: "sh_zcnt", arg: 8, scope: !1761, file: !1762, line: 404, type: !1769)
!1781 = !DILocalVariable(name: "pad", arg: 9, scope: !1761, file: !1762, line: 405, type: !160)
!1782 = !DILocation(line: 66, column: 180, scope: !1783, inlinedAt: !1784)
!1783 = distinct !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_xEv", scope: !66, file: !67, line: 66, type: !70, scopeLine: 66, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, declaration: !69)
!1784 = distinct !DILocation(line: 407, column: 11, scope: !1761)
!1785 = !DILocation(line: 79, column: 180, scope: !1786, inlinedAt: !1787)
!1786 = distinct !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_xEv", scope: !97, file: !67, line: 79, type: !70, scopeLine: 79, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, declaration: !99)
!1787 = distinct !DILocation(line: 407, column: 24, scope: !1761)
!1788 = !DILocation(line: 407, column: 22, scope: !1761)
!1789 = !DILocation(line: 53, column: 180, scope: !1790, inlinedAt: !1791)
!1790 = distinct !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_xEv", scope: !125, file: !67, line: 53, type: !70, scopeLine: 53, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, declaration: !127)
!1791 = distinct !DILocation(line: 407, column: 37, scope: !1761)
!1792 = !DILocation(line: 407, column: 35, scope: !1761)
!1793 = !DILocalVariable(name: "i", scope: !1761, file: !1762, line: 407, type: !160)
!1794 = !DILocation(line: 408, column: 9, scope: !1795)
!1795 = distinct !DILexicalBlock(scope: !1761, file: !1762, line: 408, column: 7)
!1796 = !DILocation(line: 408, column: 7, scope: !1761)
!1797 = !DILocation(line: 410, column: 17, scope: !1761)
!1798 = !DILocalVariable(name: "group", scope: !1761, file: !1762, line: 410, type: !160)
!1799 = !DILocalVariable(name: "sum", scope: !1761, file: !1762, line: 411, type: !165)
!1800 = !DILocation(line: 412, column: 15, scope: !1761)
!1801 = !DILocalVariable(name: "bound", scope: !1761, file: !1762, line: 412, type: !160)
!1802 = !DILocalVariable(name: "k", scope: !1803, file: !1762, line: 415, type: !160)
!1803 = distinct !DILexicalBlock(scope: !1761, file: !1762, line: 415, column: 3)
!1804 = !DILocation(line: 0, scope: !1803)
!1805 = !DILocation(line: 415, column: 21, scope: !1806)
!1806 = distinct !DILexicalBlock(scope: !1803, file: !1762, line: 415, column: 3)
!1807 = !DILocation(line: 415, column: 3, scope: !1803)
!1808 = !DILocation(line: 416, column: 13, scope: !1809)
!1809 = distinct !DILexicalBlock(scope: !1806, file: !1762, line: 415, column: 35)
!1810 = !DILocation(line: 416, column: 24, scope: !1809)
!1811 = !DILocalVariable(name: "j", scope: !1809, file: !1762, line: 416, type: !160)
!1812 = !DILocation(line: 0, scope: !1809)
!1813 = !DILocation(line: 417, column: 12, scope: !1809)
!1814 = !DILocation(line: 417, column: 28, scope: !1809)
!1815 = !DILocation(line: 417, column: 24, scope: !1809)
!1816 = !DILocation(line: 417, column: 22, scope: !1809)
!1817 = !DILocation(line: 417, column: 9, scope: !1809)
!1818 = !DILocation(line: 415, column: 30, scope: !1806)
!1819 = distinct !{!1819, !1807, !1820, !1821, !1822}
!1820 = !DILocation(line: 418, column: 3, scope: !1803)
!1821 = !{!"llvm.loop.mustprogress"}
!1822 = !{!"llvm.loop.unroll.count", i32 1}
!1823 = !DILocation(line: 419, column: 8, scope: !1761)
!1824 = !DILocation(line: 419, column: 3, scope: !1761)
!1825 = !DILocation(line: 419, column: 19, scope: !1761)
!1826 = !DILocation(line: 420, column: 1, scope: !1761)
