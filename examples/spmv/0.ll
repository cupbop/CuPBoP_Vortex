...
entry:
  ...
  call void @llvm.dbg.declare(metadata ptr %d_Ax.addr, metadata !1759, metadata !DIExpression()), !dbg !1772
  ...
  %0 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !dbg !1791
  %1 = call noundef i32 @llvm.nvvm.read.ptx.sreg.ntid.x(), !dbg !1794
  %mul = mul i32 %0, %1, !dbg !1797
  %2 = call noundef i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !dbg !1798
  %add = add i32 %mul, %2, !dbg !1801
  store i32 %add, ptr %i, align 4, !dbg !1790
  %3 = load i32, ptr %i, align 4, !dbg !1802
  %4 = load i32, ptr %dim.addr, align 4, !dbg !1804
  %cmp = icmp sge i32 %3, %4, !dbg !1805
...
if.end:                                           ; preds = %entry
  call void @llvm.dbg.declare(metadata ptr %group, metadata !1808, metadata !DIExpression()), !dbg !1809
  %5 = load i32, ptr %i, align 4, !dbg !1810
  %6 = load i32, ptr %pad.addr, align 4, !dbg !1811
  %div = sdiv i32 %5, %6, !dbg !1812
  store i32 %div, ptr %group, align 4, !dbg !1809
  call void @llvm.dbg.declare(metadata ptr %sum, metadata !1813, metadata !DIExpression()), !dbg !1814
  store float 0.000000e+00, ptr %sum, align 4, !dbg !1814
  call void @llvm.dbg.declare(metadata ptr %bound, metadata !1815, metadata !DIExpression()), !dbg !1816
  %7 = load ptr, ptr %sh_zcnt.addr, align 8, !dbg !1817
  %8 = load i32, ptr %group, align 4, !dbg !1818
  %idxprom = sext i32 %8 to i64, !dbg !1817
  %arrayidx = getelementptr inbounds i32, ptr %7, i64 %idxprom, !dbg !1817
  %9 = load i32, ptr %arrayidx, align 4, !dbg !1817
  store i32 %9, ptr %bound, align 4, !dbg !1816
  call void @llvm.dbg.declare(metadata ptr %k, metadata !1819, metadata !DIExpression()), !dbg !1821
  store i32 0, ptr %k, align 4, !dbg !1821
  br label %for.cond, !dbg !1822

for.cond:                                         ; preds = %for.inc, %if.end
  %10 = load i32, ptr %k, align 4, !dbg !1823
  %11 = load i32, ptr %bound, align 4, !dbg !1825
  %cmp3 = icmp slt i32 %10, %11, !dbg !1826
  br i1 %cmp3, label %for.body, label %for.end, !dbg !1827

for.body:                                         ; preds = %for.cond
  call void @llvm.dbg.declare(metadata ptr %j, metadata !1828, metadata !DIExpression()), !dbg !1830
  %12 = load ptr, ptr %jds_ptr.addr, align 8, !dbg !1831
  %13 = load i32, ptr %k, align 4, !dbg !1832
  %idxprom4 = sext i32 %13 to i64, !dbg !1831
  %arrayidx5 = getelementptr inbounds i32, ptr %12, i64 %idxprom4, !dbg !1831
  %14 = load i32, ptr %arrayidx5, align 4, !dbg !1831
  %15 = load i32, ptr %i, align 4, !dbg !1833
  %add6 = add nsw i32 %14, %15, !dbg !1834
  store i32 %add6, ptr %j, align 4, !dbg !1830
  %16 = load ptr, ptr %d_data.addr, align 8, !dbg !1835
  %17 = load i32, ptr %j, align 4, !dbg !1836
  %idxprom7 = sext i32 %17 to i64, !dbg !1835
  %arrayidx8 = getelementptr inbounds float, ptr %16, i64 %idxprom7, !dbg !1835
  %18 = load float, ptr %arrayidx8, align 4, !dbg !1835
  %19 = load ptr, ptr %d_x.addr, align 8, !dbg !1837
  %20 = load ptr, ptr %d_idx.addr, align 8, !dbg !1838
  %21 = load i32, ptr %j, align 4, !dbg !1839
  %idxprom9 = sext i32 %21 to i64, !dbg !1838
  %arrayidx10 = getelementptr inbounds i32, ptr %20, i64 %idxprom9, !dbg !1838
  %22 = load i32, ptr %arrayidx10, align 4, !dbg !1838
  %idxprom11 = sext i32 %22 to i64, !dbg !1837
  %arrayidx12 = getelementptr inbounds float, ptr %19, i64 %idxprom11, !dbg !1837
  %23 = load float, ptr %arrayidx12, align 4, !dbg !1837
  %mul13 = fmul contract float %18, %23, !dbg !1840
  %24 = load float, ptr %sum, align 4, !dbg !1841
  %add14 = fadd contract float %24, %mul13, !dbg !1841
  store float %add14, ptr %sum, align 4, !dbg !1841
  br label %for.inc, !dbg !1842

for.inc:                                          ; preds = %for.body
  %25 = load i32, ptr %k, align 4, !dbg !1843
  %inc = add nsw i32 %25, 1, !dbg !1843
  store i32 %inc, ptr %k, align 4, !dbg !1843
  br label %for.cond, !dbg !1844, !llvm.loop !1845

for.end:                                          ; preds = %for.cond
  %26 = load float, ptr %sum, align 4, !dbg !1849
  %27 = load ptr, ptr %d_Ax.addr, align 8, !dbg !1850
  %28 = load ptr, ptr %d_perm.addr, align 8, !dbg !1851
  %29 = load i32, ptr %i, align 4, !dbg !1852
  %idxprom15 = sext i32 %29 to i64, !dbg !1851
  %arrayidx16 = getelementptr inbounds i32, ptr %28, i64 %idxprom15, !dbg !1851
  %30 = load i32, ptr %arrayidx16, align 4, !dbg !1851
  %idxprom17 = sext i32 %30 to i64, !dbg !1850
  %arrayidx18 = getelementptr inbounds float, ptr %27, i64 %idxprom17, !dbg !1850
  store float %26, ptr %arrayidx18, align 4, !dbg !1853
...
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !dbg !1855
  ret i32 %0, !dbg !1856
}
...
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ntid.x(), !dbg !1857
  ret i32 %0, !dbg !1858
}
...
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !dbg !1859
  ret i32 %0, !dbg !1860
}
...
!1758 = !{i32 2, i32 0}
!1759 = !DILocalVariable(name: "d_Ax", arg: 1, scope: !1760, file: !1761, line: 397, type: !1764)
!1760 = distinct !DISubprogram(name: "spmv_jds_naive_kernel", linkageName: "_Z21spmv_jds_naive_kernelPfPKfPKiS3_S1_iS3_S3_i", scope: !1761, file: !1761, line: 396, type: !1762, scopeLine: 406, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, retainedNodes: !1771)
!1761 = !DIFile(filename: "./spmv.cu", directory: "/nethome/cahn45/CuPBoP/examples/spmv")
!1762 = !DISubroutineType(types: !1763)
!1763 = !{null, !1764, !1765, !1768, !1768, !1765, !160, !1768, !1768, !160}
!1764 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !296)
!1765 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !1766)
!1766 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1767, size: 64)
!1767 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !165)
!1768 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !1769)
!1769 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1770, size: 64)
!1770 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !160)
!1771 = !{}
!1772 = !DILocation(line: 397, column: 25, scope: !1760)
!1773 = !DILocalVariable(name: "d_data", arg: 2, scope: !1760, file: !1761, line: 398, type: !1765)
!1774 = !DILocation(line: 398, column: 31, scope: !1760)
!1775 = !DILocalVariable(name: "d_idx", arg: 3, scope: !1760, file: !1761, line: 399, type: !1768)
!1776 = !DILocation(line: 399, column: 29, scope: !1760)
!1777 = !DILocalVariable(name: "d_perm", arg: 4, scope: !1760, file: !1761, line: 400, type: !1768)
!1778 = !DILocation(line: 400, column: 29, scope: !1760)
!1779 = !DILocalVariable(name: "d_x", arg: 5, scope: !1760, file: !1761, line: 401, type: !1765)
!1780 = !DILocation(line: 401, column: 31, scope: !1760)
!1781 = !DILocalVariable(name: "dim", arg: 6, scope: !1760, file: !1761, line: 402, type: !160)
!1782 = !DILocation(line: 402, column: 9, scope: !1760)
!1783 = !DILocalVariable(name: "jds_ptr", arg: 7, scope: !1760, file: !1761, line: 403, type: !1768)
!1784 = !DILocation(line: 403, column: 29, scope: !1760)
!1785 = !DILocalVariable(name: "sh_zcnt", arg: 8, scope: !1760, file: !1761, line: 404, type: !1768)
!1786 = !DILocation(line: 404, column: 29, scope: !1760)
!1787 = !DILocalVariable(name: "pad", arg: 9, scope: !1760, file: !1761, line: 405, type: !160)
!1788 = !DILocation(line: 405, column: 9, scope: !1760)
!1789 = !DILocalVariable(name: "i", scope: !1760, file: !1761, line: 407, type: !160)
!1790 = !DILocation(line: 407, column: 7, scope: !1760)
!1791 = !DILocation(line: 66, column: 180, scope: !1792, inlinedAt: !1793)
!1792 = distinct !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_xEv", scope: !66, file: !67, line: 66, type: !70, scopeLine: 66, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, declaration: !69)
!1793 = distinct !DILocation(line: 407, column: 11, scope: !1760)
!1794 = !DILocation(line: 79, column: 180, scope: !1795, inlinedAt: !1796)
!1795 = distinct !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_xEv", scope: !97, file: !67, line: 79, type: !70, scopeLine: 79, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, declaration: !99)
!1796 = distinct !DILocation(line: 407, column: 24, scope: !1760)
!1797 = !DILocation(line: 407, column: 22, scope: !1760)
!1798 = !DILocation(line: 53, column: 180, scope: !1799, inlinedAt: !1800)
!1799 = distinct !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_xEv", scope: !125, file: !67, line: 53, type: !70, scopeLine: 53, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, declaration: !127)
!1800 = distinct !DILocation(line: 407, column: 37, scope: !1760)
!1801 = !DILocation(line: 407, column: 35, scope: !1760)
!1802 = !DILocation(line: 408, column: 7, scope: !1803)
!1803 = distinct !DILexicalBlock(scope: !1760, file: !1761, line: 408, column: 7)
!1804 = !DILocation(line: 408, column: 12, scope: !1803)
!1805 = !DILocation(line: 408, column: 9, scope: !1803)
!1806 = !DILocation(line: 408, column: 7, scope: !1760)
!1807 = !DILocation(line: 408, column: 17, scope: !1803)
!1808 = !DILocalVariable(name: "group", scope: !1760, file: !1761, line: 410, type: !160)
!1809 = !DILocation(line: 410, column: 7, scope: !1760)
!1810 = !DILocation(line: 410, column: 15, scope: !1760)
!1811 = !DILocation(line: 410, column: 19, scope: !1760)
!1812 = !DILocation(line: 410, column: 17, scope: !1760)
!1813 = !DILocalVariable(name: "sum", scope: !1760, file: !1761, line: 411, type: !165)
!1814 = !DILocation(line: 411, column: 9, scope: !1760)
!1815 = !DILocalVariable(name: "bound", scope: !1760, file: !1761, line: 412, type: !160)
!1816 = !DILocation(line: 412, column: 7, scope: !1760)
!1817 = !DILocation(line: 412, column: 15, scope: !1760)
!1818 = !DILocation(line: 412, column: 23, scope: !1760)
!1819 = !DILocalVariable(name: "k", scope: !1820, file: !1761, line: 415, type: !160)
!1820 = distinct !DILexicalBlock(scope: !1760, file: !1761, line: 415, column: 3)
!1821 = !DILocation(line: 415, column: 12, scope: !1820)
!1822 = !DILocation(line: 415, column: 8, scope: !1820)
!1823 = !DILocation(line: 415, column: 19, scope: !1824)
!1824 = distinct !DILexicalBlock(scope: !1820, file: !1761, line: 415, column: 3)
!1825 = !DILocation(line: 415, column: 23, scope: !1824)
!1826 = !DILocation(line: 415, column: 21, scope: !1824)
!1827 = !DILocation(line: 415, column: 3, scope: !1820)
!1828 = !DILocalVariable(name: "j", scope: !1829, file: !1761, line: 416, type: !160)
!1829 = distinct !DILexicalBlock(scope: !1824, file: !1761, line: 415, column: 35)
!1830 = !DILocation(line: 416, column: 9, scope: !1829)
!1831 = !DILocation(line: 416, column: 13, scope: !1829)
!1832 = !DILocation(line: 416, column: 21, scope: !1829)
!1833 = !DILocation(line: 416, column: 26, scope: !1829)
!1834 = !DILocation(line: 416, column: 24, scope: !1829)
!1835 = !DILocation(line: 417, column: 12, scope: !1829)
!1836 = !DILocation(line: 417, column: 19, scope: !1829)
!1837 = !DILocation(line: 417, column: 24, scope: !1829)
!1838 = !DILocation(line: 417, column: 28, scope: !1829)
!1839 = !DILocation(line: 417, column: 34, scope: !1829)
!1840 = !DILocation(line: 417, column: 22, scope: !1829)
!1841 = !DILocation(line: 417, column: 9, scope: !1829)
!1842 = !DILocation(line: 418, column: 3, scope: !1829)
!1843 = !DILocation(line: 415, column: 30, scope: !1824)
!1844 = !DILocation(line: 415, column: 3, scope: !1824)
!1845 = distinct !{!1845, !1827, !1846, !1847, !1848}
!1846 = !DILocation(line: 418, column: 3, scope: !1820)
!1847 = !{!"llvm.loop.mustprogress"}
!1848 = !{!"llvm.loop.unroll.count", i32 1}
!1849 = !DILocation(line: 419, column: 21, scope: !1760)
!1850 = !DILocation(line: 419, column: 3, scope: !1760)
!1851 = !DILocation(line: 419, column: 8, scope: !1760)
!1852 = !DILocation(line: 419, column: 15, scope: !1760)
!1853 = !DILocation(line: 419, column: 19, scope: !1760)
!1854 = !DILocation(line: 420, column: 1, scope: !1760)
!1855 = !DILocation(line: 66, column: 180, scope: !1792)
!1856 = !DILocation(line: 66, column: 173, scope: !1792)
!1857 = !DILocation(line: 79, column: 180, scope: !1795)
!1858 = !DILocation(line: 79, column: 173, scope: !1795)
!1859 = !DILocation(line: 53, column: 180, scope: !1799)
!1860 = !DILocation(line: 53, column: 173, scope: !1799)
