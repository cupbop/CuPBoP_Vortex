...
return p;
 ...
 extern "C" {
    extern void atomic_int_addPii_wrapper(void *args);
    extern void atomic_float_addPfS_i_wrapper(void *args);
    extern void atomic_max_kernelPiS_i_wrapper(void *args);
    extern void atomic_cas_kernelPiiii_wrapper(void *args);
}

void cuda_atomic_int_addPii_wrapper(void* args) {
    ...
    atomic_int_addPii_wrapper((void **)args);
}

void cuda_atomic_float_addPfS_i_wrapper(void* args) {
    block_index_x = blockIdx.x;
    block_index_y = blockIdx.y;
    block_index_z = blockIdx.z;
    ...
    atomic_float_addPfS_i_wrapper((void **)args);
}

void cuda_atomic_max_kernelPiS_i_wrapper(void* args) {
    block_index_x = blockIdx.x;
    block_index_y = blockIdx.y;
    block_index_z = blockIdx.z;
    ...
    atomic_max_kernelPiS_i_wrapper((void **)args);
}

void cuda_atomic_cas_kernelPiiii_wrapper(void* args) {
    block_index_x = blockIdx.x;
    block_index_y = blockIdx.y;
    block_index_z = blockIdx.z;
    ...
    atomic_cas_kernelPiiii_wrapper((void **)args);
}

vx_kernel_func_cb callbacks[] = {
    cuda_atomic_int_addPii_wrapper, 
    cuda_atomic_float_addPfS_i_wrapper, 
    cuda_atomic_max_kernelPiS_i_wrapper, 
    cuda_atomic_cas_kernelPiiii_wrapper, 
};
