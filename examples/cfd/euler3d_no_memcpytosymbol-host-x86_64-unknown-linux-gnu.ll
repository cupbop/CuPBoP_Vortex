; ModuleID = 'euler3d_no_memcpytosymbol-host-x86_64-unknown-linux-gnu.bc'
...
entry:
  ...
  %call = call noundef i32 @cudaLaunchKernel(ptr noundef @_Z40__device_stub__cuda_initialize_variablesiPfPKf, i64 %7, i32 %9, i64 %11, i32 %13, ptr noundef %kernel_args, i64 noundef %4, ptr noundef %5), !dbg !2095
...
entry:
  ...
  %call = call noundef i32 @cudaLaunchKernel(ptr noundef @_Z39__device_stub__cuda_compute_step_factoriPfS_S_, i64 %8, i32 %10, i64 %12, i32 %14, ptr noundef %kernel_args, i64 noundef %5, ptr noundef %6), !dbg !2160
...
entry:
  ...
  %call = call noundef i32 @cudaLaunchKernel(ptr noundef @_Z32__device_stub__cuda_compute_fluxiPKiPKfS2_PfS2_PK6float3S6_S6_S6_, i64 %14, i32 %16, i64 %18, i32 %20, ptr noundef %kernel_args, i64 noundef %11, ptr noundef %12), !dbg !2222
...
entry:
  ...
  %call = call noundef i32 @cudaLaunchKernel(ptr noundef @_Z29__device_stub__cuda_time_stepiiPfS_S_S_, i64 %10, i32 %12, i64 %14, i32 %16, ptr noundef %kernel_args, i64 noundef %7, ptr noundef %8), !dbg !2286
...
entry:
  %1 = call i32 @__cudaRegisterFunction(ptr %0, ptr @_Z40__device_stub__cuda_initialize_variablesiPfPKf, ptr @0, ptr @0, i32 -1, ptr null, ptr null, ptr null, ptr null, ptr null)
  %2 = call i32 @__cudaRegisterFunction(ptr %0, ptr @_Z39__device_stub__cuda_compute_step_factoriPfS_S_, ptr @1, ptr @1, i32 -1, ptr null, ptr null, ptr null, ptr null, ptr null)
  %3 = call i32 @__cudaRegisterFunction(ptr %0, ptr @_Z32__device_stub__cuda_compute_fluxiPKiPKfS2_PfS2_PK6float3S6_S6_S6_, ptr @2, ptr @2, i32 -1, ptr null, ptr null, ptr null, ptr null, ptr null)
  %4 = call i32 @__cudaRegisterFunction(ptr %0, ptr @_Z29__device_stub__cuda_time_stepiiPfS_S_S_, ptr @3, ptr @3, i32 -1, ptr null, ptr null, ptr null, ptr null, ptr null)
  ret void
}
