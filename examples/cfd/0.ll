...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %density) #8, !dbg !64
  ...
  call void @llvm.lifetime.start.p0(i64 12, ptr %momentum) #8, !dbg !69
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %density_energy) #8, !dbg !89
  ...
  call void @llvm.lifetime.start.p0(i64 12, ptr %velocity) #8, !dbg !94
  call void @_Z16compute_velocityRfR6float3S1_(ptr noundef nonnull align 4 dereferenceable(4) %density, ptr noundef nonnull align 4 dereferenceable(12) %momentum, ptr noundef nonnull align 4 dereferenceable(12) %velocity) #9, !dbg !95
  call void @llvm.lifetime.start.p0(i64 4, ptr %speed_sqd) #8, !dbg !96
  %call21 = call contract noundef float @_Z17compute_speed_sqdR6float3(ptr noundef nonnull align 4 dereferenceable(12) %velocity) #9, !dbg !97
  store float %call21, ptr %speed_sqd, align 4, !dbg !98, !tbaa !36
  call void @llvm.lifetime.start.p0(i64 4, ptr %pressure) #8, !dbg !99
  %call22 = call contract noundef float @_Z16compute_pressureRfS_S_(ptr noundef nonnull align 4 dereferenceable(4) %density, ptr noundef nonnull align 4 dereferenceable(4) %density_energy, ptr noundef nonnull align 4 dereferenceable(4) %speed_sqd) #9, !dbg !100
  store float %call22, ptr %pressure, align 4, !dbg !101, !tbaa !36
  %call23 = call contract noundef float @_Z22compute_speed_of_soundRfS_(ptr noundef nonnull align 4 dereferenceable(4) %density, ptr noundef nonnull align 4 dereferenceable(4) %pressure) #9, !dbg !102
  ...
  %call26 = call contract noundef float @_ZL5sqrtff(float noundef %8) #9, !dbg !104
  %9 = load float, ptr %speed_sqd, align 4, !dbg !105, !tbaa !36
  %call27 = call contract noundef float @_ZL5sqrtff(float noundef %9) #9, !dbg !106
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %pressure) #8, !dbg !112
  call void @llvm.lifetime.end.p0(i64 4, ptr %speed_sqd) #8, !dbg !112
  call void @llvm.lifetime.end.p0(i64 12, ptr %velocity) #8, !dbg !112
  call void @llvm.lifetime.end.p0(i64 4, ptr %density_energy) #8, !dbg !112
  call void @llvm.lifetime.end.p0(i64 12, ptr %momentum) #8, !dbg !112
  call void @llvm.lifetime.end.p0(i64 4, ptr %density) #8, !dbg !112
  ret void, !dbg !112
}
...
entry:
  ...
  %call = call contract noundef float @_ZL5sqrtff(float noundef %div) #9, !dbg !157
...
entry:
  %call = call contract float @__nv_sqrtf(float noundef %__a) #9, !dbg !159
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 12, ptr %normal) #8, !dbg !172
  call void @llvm.lifetime.start.p0(i64 4, ptr %density_i) #8, !dbg !173
  ...
  call void @llvm.lifetime.start.p0(i64 12, ptr %momentum_i) #8, !dbg !178
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %density_energy_i) #8, !dbg !194
  ...
  call void @llvm.lifetime.start.p0(i64 12, ptr %velocity_i) #8, !dbg !199
  call void @_Z16compute_velocityRfR6float3S1_(ptr noundef nonnull align 4 dereferenceable(4) %density_i, ptr noundef nonnull align 4 dereferenceable(12) %momentum_i, ptr noundef nonnull align 4 dereferenceable(12) %velocity_i) #9, !dbg !200
  call void @llvm.lifetime.start.p0(i64 4, ptr %speed_sqd_i) #8, !dbg !201
  %call21 = call contract noundef float @_Z17compute_speed_sqdR6float3(ptr noundef nonnull align 4 dereferenceable(12) %velocity_i) #9, !dbg !202
  store float %call21, ptr %speed_sqd_i, align 4, !dbg !203, !tbaa !36
  %8 = load float, ptr %speed_sqd_i, align 4, !dbg !204, !tbaa !36
  %call22 = call contract noundef float @_ZL5sqrtff(float noundef %8) #9, !dbg !205
  call void @llvm.lifetime.start.p0(i64 4, ptr %pressure_i) #8, !dbg !206
  %call23 = call contract noundef float @_Z16compute_pressureRfS_S_(ptr noundef nonnull align 4 dereferenceable(4) %density_i, ptr noundef nonnull align 4 dereferenceable(4) %density_energy_i, ptr noundef nonnull align 4 dereferenceable(4) %speed_sqd_i) #9, !dbg !207
  store float %call23, ptr %pressure_i, align 4, !dbg !208, !tbaa !36
  %call24 = call contract noundef float @_Z22compute_speed_of_soundRfS_(ptr noundef nonnull align 4 dereferenceable(4) %density_i, ptr noundef nonnull align 4 dereferenceable(4) %pressure_i) #9, !dbg !209
  call void @llvm.lifetime.start.p0(i64 12, ptr %flux_contribution_i_momentum_x) #8, !dbg !210
  call void @llvm.lifetime.start.p0(i64 12, ptr %flux_contribution_i_momentum_y) #8, !dbg !210
  call void @llvm.lifetime.start.p0(i64 12, ptr %flux_contribution_i_momentum_z) #8, !dbg !210
  call void @llvm.lifetime.start.p0(i64 12, ptr %flux_contribution_i_density_energy) #8, !dbg !211
  call void @_Z25compute_flux_contributionRfR6float3S_S_S1_S1_S1_S1_S1_(ptr noundef nonnull align 4 dereferenceable(4) %density_i, ptr noundef nonnull align 4 dereferenceable(12) %momentum_i, ptr noundef nonnull align 4 dereferenceable(4) %density_energy_i, ptr noundef nonnull align 4 dereferenceable(4) %pressure_i, ptr noundef nonnull align 4 dereferenceable(12) %velocity_i, ptr noundef nonnull align 4 dereferenceable(12) %flux_contribution_i_momentum_x, ptr noundef nonnull align 4 dereferenceable(12) %flux_contribution_i_momentum_y, ptr noundef nonnull align 4 dereferenceable(12) %flux_contribution_i_momentum_z, ptr noundef nonnull align 4 dereferenceable(12) %flux_contribution_i_density_energy) #9, !dbg !212
  call void @llvm.lifetime.start.p0(i64 12, ptr %flux_i_momentum) #8, !dbg !213
  ...
  call void @llvm.lifetime.start.p0(i64 12, ptr %velocity_nb) #8, !dbg !220
  call void @llvm.lifetime.start.p0(i64 4, ptr %density_nb) #8, !dbg !221
  call void @llvm.lifetime.start.p0(i64 4, ptr %density_energy_nb) #8, !dbg !221
  call void @llvm.lifetime.start.p0(i64 12, ptr %momentum_nb) #8, !dbg !222
  call void @llvm.lifetime.start.p0(i64 12, ptr %flux_contribution_nb_momentum_x) #8, !dbg !223
  call void @llvm.lifetime.start.p0(i64 12, ptr %flux_contribution_nb_momentum_y) #8, !dbg !223
  call void @llvm.lifetime.start.p0(i64 12, ptr %flux_contribution_nb_momentum_z) #8, !dbg !223
  call void @llvm.lifetime.start.p0(i64 12, ptr %flux_contribution_nb_density_energy) #8, !dbg !224
  call void @llvm.lifetime.start.p0(i64 4, ptr %speed_sqd_nb) #8, !dbg !225
  call void @llvm.lifetime.start.p0(i64 4, ptr %pressure_nb) #8, !dbg !225
...
for.body:                                         ; preds = %for.cond
  ...
  %call61 = call contract noundef float @_ZL5sqrtff(float noundef %add60) #9, !dbg !265
...
if.then:                                          ; preds = %for.body
  ...
  call void @_Z16compute_velocityRfR6float3S1_(ptr noundef nonnull align 4 dereferenceable(4) %density_nb, ptr noundef nonnull align 4 dereferenceable(12) %momentum_nb, ptr noundef nonnull align 4 dereferenceable(12) %velocity_nb) #9, !dbg !291
  %call86 = call contract noundef float @_Z17compute_speed_sqdR6float3(ptr noundef nonnull align 4 dereferenceable(12) %velocity_nb) #9, !dbg !292
  store float %call86, ptr %speed_sqd_nb, align 4, !dbg !293, !tbaa !36
  %call87 = call contract noundef float @_Z16compute_pressureRfS_S_(ptr noundef nonnull align 4 dereferenceable(4) %density_nb, ptr noundef nonnull align 4 dereferenceable(4) %density_energy_nb, ptr noundef nonnull align 4 dereferenceable(4) %speed_sqd_nb) #9, !dbg !294
  store float %call87, ptr %pressure_nb, align 4, !dbg !295, !tbaa !36
  %call88 = call contract noundef float @_Z22compute_speed_of_soundRfS_(ptr noundef nonnull align 4 dereferenceable(4) %density_nb, ptr noundef nonnull align 4 dereferenceable(4) %pressure_nb) #9, !dbg !296
  ...
  %call91 = call contract noundef float @_ZL5sqrtff(float noundef %27) #9, !dbg !302
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %pressure_nb) #8, !dbg !572
  call void @llvm.lifetime.end.p0(i64 4, ptr %speed_sqd_nb) #8, !dbg !572
  call void @llvm.lifetime.end.p0(i64 12, ptr %flux_contribution_nb_density_energy) #8, !dbg !572
  call void @llvm.lifetime.end.p0(i64 12, ptr %flux_contribution_nb_momentum_z) #8, !dbg !572
  call void @llvm.lifetime.end.p0(i64 12, ptr %flux_contribution_nb_momentum_y) #8, !dbg !572
  call void @llvm.lifetime.end.p0(i64 12, ptr %flux_contribution_nb_momentum_x) #8, !dbg !572
  call void @llvm.lifetime.end.p0(i64 12, ptr %momentum_nb) #8, !dbg !572
  call void @llvm.lifetime.end.p0(i64 4, ptr %density_energy_nb) #8, !dbg !572
  call void @llvm.lifetime.end.p0(i64 4, ptr %density_nb) #8, !dbg !572
  call void @llvm.lifetime.end.p0(i64 12, ptr %velocity_nb) #8, !dbg !572
  call void @llvm.lifetime.end.p0(i64 12, ptr %flux_i_momentum) #8, !dbg !572
  call void @llvm.lifetime.end.p0(i64 12, ptr %flux_contribution_i_density_energy) #8, !dbg !572
  call void @llvm.lifetime.end.p0(i64 12, ptr %flux_contribution_i_momentum_z) #8, !dbg !572
  call void @llvm.lifetime.end.p0(i64 12, ptr %flux_contribution_i_momentum_y) #8, !dbg !572
  call void @llvm.lifetime.end.p0(i64 12, ptr %flux_contribution_i_momentum_x) #8, !dbg !572
  call void @llvm.lifetime.end.p0(i64 4, ptr %pressure_i) #8, !dbg !572
  call void @llvm.lifetime.end.p0(i64 4, ptr %speed_sqd_i) #8, !dbg !572
  call void @llvm.lifetime.end.p0(i64 12, ptr %velocity_i) #8, !dbg !572
  call void @llvm.lifetime.end.p0(i64 4, ptr %density_energy_i) #8, !dbg !572
  call void @llvm.lifetime.end.p0(i64 12, ptr %momentum_i) #8, !dbg !572
  call void @llvm.lifetime.end.p0(i64 4, ptr %density_i) #8, !dbg !572
  call void @llvm.lifetime.end.p0(i64 12, ptr %normal) #8, !dbg !572
  ret void, !dbg !572
}
